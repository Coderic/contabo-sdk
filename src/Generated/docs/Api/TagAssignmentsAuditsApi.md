# Coderic\Contabo\Generated\TagAssignmentsAuditsApi
...
```php
retrieveAssignmentsAuditsList($xRequestId, $xTraceId, $page, $size, $orderBy, $tagId, $resourceId, $requestId, $changedBy, $startDate, $endDate): \Coderic\Contabo\Generated\Model\ListAssignmentAuditsResponse
```
...
$apiInstance = new Coderic\Contabo\Generated\Api\TagAssignmentsAuditsApi(
...
[**\Coderic\Contabo\Generated\Model\ListAssignmentAuditsResponse**](../Model/ListAssignmentAuditsResponse.md)
