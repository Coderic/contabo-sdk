# Coderic\Contabo\Generated\RemediesApi
...
```php
cancelExtRemedy($xRequestId, $remedyId, $cancelRequest, $xTraceId): \Coderic\Contabo\Generated\Model\ExtRemediesGetResponse
```
...
$apiInstance = new Coderic\Contabo\Generated\Api\RemediesApi(
...
[**\Coderic\Contabo\Generated\Model\ExtRemediesGetResponse**](../Model/ExtRemediesGetResponse.md)
...
```php
getExtRemedy($xRequestId, $remedyId, $xTraceId): \Coderic\Contabo\Generated\Model\ExtRemediesGetResponse
```
...
```php
listExtRemedies($xRequestId, $xTraceId, $objectType, $objectId, $status, $remedyCollectionId, $remedyTemplateId): \Coderic\Contabo\Generated\Model\ExtRemediesListResponse
```
...
[**\Coderic\Contabo\Generated\Model\ExtRemediesListResponse**](../Model/ExtRemediesListResponse.md)
...
```php
startExtRemedy($xRequestId, $baseRemedyCreateRequest, $xTraceId): \Coderic\Contabo\Generated\Model\ExtRemediesGetResponse
```
...
$xRequestId = 04e0f898-37b4-48bc-a794-1a57abe6aa31; // string | [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
$baseRemedyCreateRequest = new \Coderic\Contabo\Generated\Model\BaseRemedyCreateRequest(); // \Coderic\Contabo\Generated\Model\BaseRemedyCreateRequest
$xTraceId = 'xTraceId_example'; // string | Identifier to trace group of requests.
...
| ------------- | ------------- | ------------- | ------------- |
| **xRequestId** | **string**| [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. | |
| **baseRemedyCreateRequest** | [**\Coderic\Contabo\Generated\Model\BaseRemedyCreateRequest**](../Model/BaseRemedyCreateRequest.md)|  | |
| **xTraceId** | **string**| Identifier to trace group of requests. | [optional] |
