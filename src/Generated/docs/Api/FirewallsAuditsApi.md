...
$firewallId = 1b943b25a-c8b5-4570-9135-4bbaa7615b812345; // string | The identifier of the Firewall.
...
try {
    $result = $apiInstance->retrieveFirewallAuditsList($xRequestId, $xTraceId, $page, $size, $orderBy, $firewallId, $requestId, $changedBy, $startDate, $endDate);
    print_r($result);
} catch (Exception $e) {
...
| **firewallId** | **string**| The identifier of the Firewall. | [optional] |
