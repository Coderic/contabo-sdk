# Coderic\Contabo\Generated\PrivateNetworksAuditsApi
...
```php
retrievePrivateNetworkAuditsList($xRequestId, $xTraceId, $page, $size, $orderBy, $privateNetworkId, $requestId, $changedBy, $startDate, $endDate): \Coderic\Contabo\Generated\Model\ListPrivateNetworkAuditResponse
```
...
$apiInstance = new Coderic\Contabo\Generated\Api\PrivateNetworksAuditsApi(
...
$endDate = Tue May 30 19:00:00 GMT-05:00 2023; // \DateTime | End of search time range.

try {
    $result = $apiInstance->retrievePrivateNetworkAuditsList($xRequestId, $xTraceId, $page, $size, $orderBy, $privateNetworkId, $requestId, $changedBy, $startDate, $endDate);
    print_r($result);
} catch (Exception $e) {
...
| **privateNetworkId** | **int**| The identifier of the Private Network | [optional] |
...
[**\Coderic\Contabo\Generated\Model\ListPrivateNetworkAuditResponse**](../Model/ListPrivateNetworkAuditResponse.md)
