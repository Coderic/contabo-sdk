# Coderic\Contabo\Generated\InternalRemedyAuditsApi
...
```php
retrieveRemediesAuditsList($xRequestId, $orgIds, $xTraceId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $accountId, $requestId, $foreignChangedBy, $changedBy, $remedyId): \Coderic\Contabo\Generated\Model\RemediesAuditListResponse
```
...
$apiInstance = new Coderic\Contabo\Generated\Api\InternalRemedyAuditsApi(
...
try {
    $result = $apiInstance->retrieveRemediesAuditsList($xRequestId, $orgIds, $xTraceId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $accountId, $requestId, $foreignChangedBy, $changedBy, $remedyId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling InternalRemedyAuditsApi->retrieveRemediesAuditsList: ', $e->getMessage(), PHP_EOL;
}
```
...
| **remedyId** | **float**| Remedy&#39;s id | [optional] |

### Return type

[**\Coderic\Contabo\Generated\Model\RemediesAuditListResponse**](../Model/RemediesAuditListResponse.md)
