# Contabo\Generated\InternalRemedyAuditsApi
...
```php
retrieveRemediesAuditsList($xRequestId, $orgIds, $xTraceId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $accountId, $requestId, $foreignChangedBy, $changedBy, $remedyId): \Contabo\Generated\Model\RemediesAuditListResponse
```
...
$apiInstance = new Contabo\Generated\Api\InternalRemedyAuditsApi(
...
[**\Contabo\Generated\Model\RemediesAuditListResponse**](../Model/RemediesAuditListResponse.md)
