# Contabo\Generated\SecretsAuditsApi
...
```php
retrieveSecretAuditsList($xRequestId, $xTraceId, $page, $size, $orderBy, $secretId, $requestId, $changedBy, $startDate, $endDate): \Contabo\Generated\Model\ListSecretAuditResponse
```
...
$apiInstance = new Contabo\Generated\Api\SecretsAuditsApi(
...
[**\Contabo\Generated\Model\ListSecretAuditResponse**](../Model/ListSecretAuditResponse.md)
