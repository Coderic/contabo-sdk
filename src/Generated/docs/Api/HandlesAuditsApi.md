# Coderic\Contabo\Generated\HandlesAuditsApi
...
```php
retrieveHandlesAuditsList($xRequestId, $xTraceId, $page, $size, $orderBy, $handleId, $requestId, $changedBy, $startDate, $endDate): \Coderic\Contabo\Generated\Model\HandleAuditResponse
```
...
$apiInstance = new Coderic\Contabo\Generated\Api\HandlesAuditsApi(
...
try {
    $result = $apiInstance->retrieveHandlesAuditsList($xRequestId, $xTraceId, $page, $size, $orderBy, $handleId, $requestId, $changedBy, $startDate, $endDate);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling HandlesAuditsApi->retrieveHandlesAuditsList: ', $e->getMessage(), PHP_EOL;
}
```
...
| **handleId** | **string**| The identifier of the handle. | [optional] |
...
[**\Coderic\Contabo\Generated\Model\HandleAuditResponse**](../Model/HandleAuditResponse.md)
