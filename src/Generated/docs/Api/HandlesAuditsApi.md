# Contabo\Generated\HandlesAuditsApi
...
```php
retrieveHandlesAuditsList($xRequestId, $xTraceId, $page, $size, $orderBy, $handleId, $requestId, $changedBy, $startDate, $endDate): \Contabo\Generated\Model\HandleAuditResponse
```
...
$apiInstance = new Contabo\Generated\Api\HandlesAuditsApi(
...
[**\Contabo\Generated\Model\HandleAuditResponse**](../Model/HandleAuditResponse.md)
