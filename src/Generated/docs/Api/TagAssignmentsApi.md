...
try {
    $result = $apiInstance->createAssignment($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId);
    print_r($result);
} catch (Exception $e) {
...
```php
deleteAssignment($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId)
```
...
try {
    $apiInstance->deleteAssignment($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->retrieveAssignment($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId);
    print_r($result);
} catch (Exception $e) {
...
$resourceType = instance; // string | Filter as substring match for assignment resource type. Resource type is one of `instance|image|object-storage`.

try {
    $result = $apiInstance->retrieveAssignmentList($xRequestId, $tagId, $xTraceId, $page, $size, $orderBy, $resourceType);
    print_r($result);
} catch (Exception $e) {
...
| **resourceType** | **string**| Filter as substring match for assignment resource type. Resource type is one of &#x60;instance|image|object-storage&#x60;. | [optional] |
