...
try {
    $result = $apiInstance->retrieveSnapshotsAuditsList($xRequestId, $xTraceId, $page, $size, $orderBy, $instanceId, $snapshotId, $requestId, $changedBy, $startDate, $endDate);
    print_r($result);
} catch (Exception $e) {
...
| **instanceId** | **int**| The identifier of the instance | [optional] |
| **snapshotId** | **string**| The identifier of the snapshot | [optional] |
