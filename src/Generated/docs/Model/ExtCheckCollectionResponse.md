...
**checkTemplates** | [**\Coderic\Contabo\Generated\Model\CheckCollectionCheckTemplates[]**](CheckCollectionCheckTemplates.md) | Check templates which are part of this collection template |
**createdDate** | **\DateTime** | Creation date |
**modifiedDate** | **\DateTime** | Modify date |
**tenantId** | **string** | Tenant id |
**customerId** | **string** | Customer id |
**checks** | [**\Coderic\Contabo\Generated\Model\ExtCheckResponse[]**](ExtCheckResponse.md) | Checks performed in this check collection |
