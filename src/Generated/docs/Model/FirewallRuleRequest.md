...
**srcCidr** | [**\Coderic\Contabo\Generated\Model\SrcCidr**](SrcCidr.md) | Source CIDR configuration. Use \&quot;AnyIPv4\&quot; to allow all IPv4 sources (0.0.0.0/0) or \&quot;AnyIPv6\&quot; to allow all IPv6 sources (::/0). Both can be combined to allow all IP sources. Regular CIDR notation is also supported. |
