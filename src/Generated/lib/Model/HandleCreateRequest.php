...
/**
 * HandleCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class HandleCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HandleCreateRequest';
    ...
    */
     ...
     * Sets handleType
     *
     * @param string $handleType The type of the handle
     *
     * @return self
     */
    ...
    public function setFirstName($firstName)
    {
        ...
        if ((mb_strlen($firstName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling HandleCreateRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($firstName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling HandleCreateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($lastName)
    {
        ...
        if ((mb_strlen($lastName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling HandleCreateRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($lastName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling HandleCreateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setOrganization($organization)
    {
        ...
        if ((mb_strlen($organization) > 255)) {
            throw new \InvalidArgumentException('invalid length for $organization when calling HandleCreateRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($organization) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organization when calling HandleCreateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling HandleCreateRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling HandleCreateRequest., must be bigger than or equal to 1.');
        }
