...
/**
 * BulkDeleteResultResponse Class Doc Comment
 *
 * @category Class
 * @package  Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class BulkDeleteResultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkDeleteResultResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('failedIds', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['failedIds'] === null) {
            $invalidProperties[] = "'failedIds' can't be null";
        }
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling BulkDeleteResultResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling BulkDeleteResultResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets failedIds
     *
     * @param int[] $failedIds Failed zone record IDs
     *
     * @return self
     */
    public function setFailedIds($failedIds)
    {
        if (is_null($failedIds)) {
            throw new \InvalidArgumentException('non-nullable failedIds cannot be null');
        }
