...
/**
 * OptimalRequirements Class Doc Comment
 *
 * @category Class
 * @package  Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class OptimalRequirements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OptimalRequirements';
    ...
    protected static $setters = [
        ...
        'ramMb' => 'setRamMb',
        'diskMb' => 'setDiskMb',
        'validProductIds' => 'setValidProductIds'
    ];
    ...
    protected static $getters = [
        ...
        'ramMb' => 'getRamMb',
        'diskMb' => 'getDiskMb',
        'validProductIds' => 'getValidProductIds'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('validProductIds', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets cpuCores
     *
     * @param float|null $cpuCores CPU Cores Requirement
     *
     * @return self
     */
     ...
     * Sets ramMb
     *
     * @param float|null $ramMb Memory Requirement in MB
     *
     * @return self
     */
     ...
     * Sets diskMb
     *
     * @param float|null $diskMb Storage Requirement in MB
     *
     * @return self
     */
    ...
    /**
     * Gets validProductIds
     *
     * @return string[]|null
     */
    public function getValidProductIds()
    {
        return $this->container['validProductIds'];
    }

    /**
     * Sets validProductIds
     *
     * @param string[]|null $validProductIds Valid Product IDs for this application
     *
     * @return self
     */
    public function setValidProductIds($validProductIds)
    {
        if (is_null($validProductIds)) {
            throw new \InvalidArgumentException('non-nullable validProductIds cannot be null');
        }
        $this->container['validProductIds'] = $validProductIds;
