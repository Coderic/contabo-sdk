...
/**
 * UpdateDnsZoneRecordRequest Class Doc Comment
 *
 * @category Class
 * @package  Coderic\Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDnsZoneRecordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDnsZoneRecordRequest';
    ...
    */
    ...
    public function setData($data)
    {
        ...
        if ((mb_strlen($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling UpdateDnsZoneRecordRequest., must be bigger than or equal to 1.');
        }
