 ...
 */
class HandleResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HandleResponse';
    ...
    public const HANDLE_TYPE_PERSON = 'person';
    public const HANDLE_TYPE_ORGANIZATION = 'organization';
    public const GENDER_MALE = 'male';
    public const GENDER_FEMALE = 'female';
    public const GENDER_NA = 'na';
     ...
     * @return string[]
     */
    public function getHandleTypeAllowableValues()
    {
        return [
            self::HANDLE_TYPE_PERSON,
            self::HANDLE_TYPE_ORGANIZATION,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('handleId', $data ?? [], null);
        $this->setIfExists('handleType', $data ?? [], null);
        ...
        $this->setIfExists('birthInfo', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['handleId'] === null) {
            $invalidProperties[] = "'handleId' can't be null";
        }
        if ($this->container['handleType'] === null) {
            $invalidProperties[] = "'handleType' can't be null";
        }
        $allowedValues = $this->getHandleTypeAllowableValues();
        if (!is_null($this->container['handleType']) && !in_array($this->container['handleType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'handleType', must be one of '%s'",
                $this->container['handleType'],
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling HandleResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling HandleResponse., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['handleId'];
    }
    ...
    {
        if (is_null($handleId)) {
            throw new \InvalidArgumentException('non-nullable handleId cannot be null');
        }
        $this->container['handleId'] = $handleId;
    ...
    {
        if (is_null($handleType)) {
            throw new \InvalidArgumentException('non-nullable handleType cannot be null');
        }
        $allowedValues = $this->getHandleTypeAllowableValues();
        if (!in_array($handleType, $allowedValues, true)) {
     ...
     * Sets isDefault
     *
     * @param bool $isDefault Flag if the handle is default or not
     *
     * @return self
     */
     ...
     * Sets firstName
     *
     * @param string $firstName Handle first name
     *
     * @return self
     */
    public function setFirstName($firstName)
    {
        ...
        if ((mb_strlen($firstName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling HandleResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($firstName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling HandleResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets lastName
     *
     * @param string $lastName Handle last name
     *
     * @return self
     */
    public function setLastName($lastName)
    {
        ...
        if ((mb_strlen($lastName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling HandleResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($lastName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling HandleResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets organization
     *
     * @param string|null $organization The organization of the handle
     *
     * @return self
     */
    public function setOrganization($organization)
    {
        ...
        if ((mb_strlen($organization) > 255)) {
            throw new \InvalidArgumentException('invalid length for $organization when calling HandleResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($organization) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organization when calling HandleResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets email
     *
     * @param string $email Handle email
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling HandleResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling HandleResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets gender
     *
     * @param string $gender Handle gender
     *
     * @return self
     */
    ...
    {
        return $this->container['birthInfo'];
    }
     ...
     * @return self
     */
    public function setBirthInfo($birthInfo)
    {
        if (is_null($birthInfo)) {
            throw new \InvalidArgumentException('non-nullable birthInfo cannot be null');
        }
        $this->container['birthInfo'] = $birthInfo;
