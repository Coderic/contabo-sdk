    ...
    */
    ...
    public function setFirstName($firstName)
    {
        ...
        if ((mb_strlen($firstName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling CreateUserRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($firstName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling CreateUserRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($lastName)
    {
        ...
        if ((mb_strlen($lastName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling CreateUserRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($lastName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling CreateUserRequest., must be bigger than or equal to 1.');
        }
