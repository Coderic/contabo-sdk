 ...
 */
class ApplicationConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationConfig';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('userDataId', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['userDataId'] === null) {
            $invalidProperties[] = "'userDataId' can't be null";
        }
    ...
    {
        return $this->container['userDataId'];
    }
    ...
    {
        if (is_null($userDataId)) {
            throw new \InvalidArgumentException('non-nullable userDataId cannot be null');
        }
        $this->container['userDataId'] = $userDataId;
     ...
     * Sets userData
     *
     * @param string $userData [Cloud-Init](https://cloud-init.io/) Config in order to customize during start of compute instance.
     *
     * @return self
     */
