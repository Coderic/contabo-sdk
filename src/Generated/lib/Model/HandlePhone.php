 ...
 */
class HandlePhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HandlePhone';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['prefix']) > 5)) {
            $invalidProperties[] = "invalid value for 'prefix', the character length must be smaller than or equal to 5.";
        }
    ...
    public function setPrefix($prefix)
    {
        ...
        if ((mb_strlen($prefix) > 5)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling HandlePhone., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($prefix) < 1)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling HandlePhone., must be bigger than or equal to 1.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $number when calling HandlePhone., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling HandlePhone., must be bigger than or equal to 1.');
        }
