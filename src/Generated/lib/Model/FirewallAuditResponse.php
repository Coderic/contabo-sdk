...
class FirewallAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets firewallId
     *
     * @param string $firewallId The identifier of the Firewall
     *
     * @return self
     */
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling FirewallAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling FirewallAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setChangedBy($changedBy)
    {
        ...
        if ((mb_strlen($changedBy) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changedBy when calling FirewallAuditResponse., must be bigger than or equal to 1.');
        }
