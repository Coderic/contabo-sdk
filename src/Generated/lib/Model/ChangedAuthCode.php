...
/**
 * ChangedAuthCode Class Doc Comment
 *
 * @category Class
 * @package  Coderic\Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ChangedAuthCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangedAuthCode';
    ...
    */
     ...
     * Sets changed
     *
     * @param bool|null $changed Flag that indicates if the auth code got changed
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date when auth code got changed
     *
     * @return self
     */
