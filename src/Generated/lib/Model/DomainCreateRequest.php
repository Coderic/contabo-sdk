...
class DomainCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const RESOURCE_TYPE_PACKAGE = 'package';
    ...
    */
     ...
     * Sets authCode
     *
     * @param string|null $authCode The domain auth code
     *
     * @return self
     */
     ...
     * Sets resourceType
     *
     * @param string|null $resourceType The identifier of the resource type
     *
     * @return self
     */
     ...
     * Sets resourceId
     *
     * @param string|null $resourceId The identifier of the resource id
     *
     * @return self
     */
