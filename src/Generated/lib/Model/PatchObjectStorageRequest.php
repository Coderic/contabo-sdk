...
class PatchObjectStorageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets displayName
     *
     * @param string $displayName Display name helps to differentiate between object storages, especially if they are in the same region.
     *
     * @return self
     */
    public function setDisplayName($displayName)
    {
        ...
        if ((mb_strlen($displayName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling PatchObjectStorageRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($displayName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling PatchObjectStorageRequest., must be bigger than or equal to 1.');
        }
