...
class CheckResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckResponse';
    ...
    */
     ...
     *
     * @param float $checkCollectionId ID of check collection if started in scope of a collection
     *
     * @return self
     */
     ...
     *
     * @param float $checkTemplateId Check Template for this check
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Name of this check template
     *
     * @return self
     */
     ...
     * Sets durationMs
     *
     * @param float $durationMs Duration of the check in milliseconds
     *
     * @return self
     */
    ...
    public function setOrgId($orgId)
    {
        ...
        if ((mb_strlen($orgId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orgId when calling CheckResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAccountId($accountId)
    {
        ...
        if ((mb_strlen($accountId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $accountId when calling CheckResponse., must be bigger than or equal to 1.');
        }
