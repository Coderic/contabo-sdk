...
/**
 * VipAuditResponse Class Doc Comment
 *
 * @category Class
 * @package  Coderic\Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class VipAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VipAuditResponse';
    ...
    */
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling VipAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling VipAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setChangedBy($changedBy)
    {
        ...
        if ((mb_strlen($changedBy) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changedBy when calling VipAuditResponse., must be bigger than or equal to 1.');
        }
