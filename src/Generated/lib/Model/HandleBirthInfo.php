...
/**
 * HandleBirthInfo Class Doc Comment
 *
 * @category Class
 * @package  Coderic\Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class HandleBirthInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HandleBirthInfo';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['zipCode']) && (mb_strlen($this->container['zipCode']) > 50)) {
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $city when calling HandleBirthInfo., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling HandleBirthInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setZipCode($zipCode)
    {
        ...
        if ((mb_strlen($zipCode) > 50)) {
            throw new \InvalidArgumentException('invalid length for $zipCode when calling HandleBirthInfo., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($zipCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $zipCode when calling HandleBirthInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 100)) {
            throw new \InvalidArgumentException('invalid length for $country when calling HandleBirthInfo., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($country) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country when calling HandleBirthInfo., must be bigger than or equal to 1.');
        }
