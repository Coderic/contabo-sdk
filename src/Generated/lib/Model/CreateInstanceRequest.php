...
class CreateInstanceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('imageId', $data ?? [], 'afecbb85-e2fc-46f0-9684-b46b1faf00bb');
        $this->setIfExists('productId', $data ?? [], 'V92');
        ...
        $this->setIfExists('defaultUser', $data ?? [], 'admin');
    ...
    */
     ...
     * Sets imageId
     *
     * @param string|null $imageId ImageId to be used to setup the compute instance. Default is Ubuntu 22.04
     *
     * @return self
     */
     ...
     * Sets productId
     *
     * @param string|null $productId Default is V92
     *
     * @return self
     */
    public function setProductId($productId)
    {
        ...
        if ((mb_strlen($productId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $productId when calling CreateInstanceRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets sshKeys
     *
     * @param int[]|null $sshKeys Array of `secretId`s of public SSH keys for logging into as `defaultUser` with administrator/root privileges. Applies to Linux/BSD systems. Please refer to Secrets Management API.
     *
     * @return self
     */
     ...
     * Sets rootPassword
     *
     * @param int|null $rootPassword `secretId` of the password for the `defaultUser` with administrator/root privileges. For Linux/BSD please use SSH, for Windows RDP. Please refer to Secrets Management API.
     *
     * @return self
     */
     ...
     * Sets userData
     *
     * @param string|null $userData [Cloud-Init](https://cloud-init.io/) Config in order to customize during start of compute instance.
     *
     * @return self
     */
     ...
     * Sets displayName
     *
     * @param string|null $displayName The display name of the instance
     *
     * @return self
     */
    public function setDisplayName($displayName)
    {
        ...
        if ((mb_strlen($displayName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling CreateInstanceRequest., must be smaller than or equal to 255.');
        }
