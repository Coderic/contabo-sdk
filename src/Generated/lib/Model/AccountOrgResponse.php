...
/**
 * AccountOrgResponse Class Doc Comment
 *
 * @category Class
 * @package  Coderic\Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class AccountOrgResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountOrgResponse';
    ...
    */
    ...
    public function setOrgId($orgId)
    {
        ...
        if ((mb_strlen($orgId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orgId when calling AccountOrgResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAccountId($accountId)
    {
        ...
        if ((mb_strlen($accountId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $accountId when calling AccountOrgResponse., must be bigger than or equal to 1.');
        }
