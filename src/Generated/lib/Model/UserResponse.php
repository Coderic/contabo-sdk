    ...
    */
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling UserResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling UserResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets firstName
     *
     * @param string $firstName The first name of the user. Users may contain letters, numbers, colons, dashes, and underscores. There is a limit of 255 characters per user.
     *
     * @return self
     */
    public function setFirstName($firstName)
    {
        ...
        if ((mb_strlen($firstName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling UserResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($firstName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling UserResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets lastName
     *
     * @param string $lastName The last name of the user. Users may contain letters, numbers, colons, dashes, and underscores. There is a limit of 255 characters per user.
     *
     * @return self
     */
    public function setLastName($lastName)
    {
        ...
        if ((mb_strlen($lastName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling UserResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($lastName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling UserResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets emailVerified
     *
     * @param bool $emailVerified User email verification status.
     *
     * @return self
     */
     ...
     * Sets locale
     *
     * @param string $locale The locale of the user. This can be `de-DE`, `de`, `en-US`, `en`, `es-ES`, `es`, `pt-BR`, `pt`.
     *
     * @return self
     */
