...
/**
 * AuditCountResponse Class Doc Comment
 *
 * @category Class
 * @package  Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class AuditCountResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuditCountResponse';
    ...
    */
    ...
    public function setOrgId($orgId)
    {
        ...
        if ((mb_strlen($orgId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orgId when calling AuditCountResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAccountId($accountId)
    {
        ...
        if ((mb_strlen($accountId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $accountId when calling AuditCountResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets count
     *
     * @param float $count Audit for replay quantity
     *
     * @return self
     */
