...
/**
 * CreateDnsZoneRecordRequest Class Doc Comment
 *
 * @category Class
 * @package  Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class CreateDnsZoneRecordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDnsZoneRecordRequest';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name, if empty the zone name will be used
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateDnsZoneRecordRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setData($data)
    {
        ...
        if ((mb_strlen($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling CreateDnsZoneRecordRequest., must be bigger than or equal to 1.');
        }
