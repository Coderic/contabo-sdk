...
class VncResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('vncIp', $data ?? [], null);
        $this->setIfExists('vncPort', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vncIp'] === null) {
            $invalidProperties[] = "'vncIp' can't be null";
        }
        if ($this->container['vncPort'] === null) {
            $invalidProperties[] = "'vncPort' can't be null";
        }
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling VncResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling VncResponse., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['vncIp'];
    }

    /**
     * Sets vncIp
     *
     * @param string $vncIp VNC IP for the instance.
     *
     * @return self
     */
    ...
    {
        if (is_null($vncIp)) {
            throw new \InvalidArgumentException('non-nullable vncIp cannot be null');
        }
        $this->container['vncIp'] = $vncIp;
    ...
    {
        return $this->container['vncPort'];
    }

    /**
     * Sets vncPort
     *
     * @param float $vncPort VNC Port for the instance.
     *
     * @return self
     */
    ...
    {
        if (is_null($vncPort)) {
            throw new \InvalidArgumentException('non-nullable vncPort cannot be null');
        }
        $this->container['vncPort'] = $vncPort;
