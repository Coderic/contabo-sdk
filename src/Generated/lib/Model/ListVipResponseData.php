...
class ListVipResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'ipVersion' => 'string',
        'type' => 'string',
        'v4' => '\Coderic\Contabo\Generated\Model\IpV4'
    ];
    ...
    protected static $setters = [
        ...
        'resourceDisplayName' => 'setResourceDisplayName',
    ...
    public const RESOURCE_TYPE_INSTANCES = 'instances';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('vipId', $data ?? [], null);
        ...
        $this->setIfExists('resourceDisplayName', $data ?? [], null);
        $this->setIfExists('ipVersion', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['resourceDisplayName'] === null) {
            $invalidProperties[] = "'resourceDisplayName' can't be null";
        }
        ...
        if (!is_null($this->container['ipVersion']) && !in_array($this->container['ipVersion'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'ipVersion', must be one of '%s'",
                $this->container['ipVersion'],
                implode("', '", $allowedValues)
            );
        }
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling ListVipResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling ListVipResponseData., must be bigger than or equal to 1.');
        }
    ...
    {
        if (is_null($vipId)) {
            throw new \InvalidArgumentException('non-nullable vipId cannot be null');
        }
     ...
     * Sets dataCenter
     *
     * @param string $dataCenter data center.
     *
     * @return self
     */
     ...
     * Sets resourceType
     *
     * @param string|null $resourceType The resourceType using the VIP.
     *
     * @return self
     */
    ...
    /**
     * Gets resourceDisplayName
     *
     * @return string
     */
    public function getResourceDisplayName()
    {
        return $this->container['resourceDisplayName'];
    }

    /**
     * Sets resourceDisplayName
     *
     * @param string $resourceDisplayName Resource display name.
     *
     * @return self
     */
    public function setResourceDisplayName($resourceDisplayName)
    {
        if (is_null($resourceDisplayName)) {
            throw new \InvalidArgumentException('non-nullable resourceDisplayName cannot be null');
        }
        $this->container['resourceDisplayName'] = $resourceDisplayName;
     ...
     * Sets ipVersion
     *
     * @param string $ipVersion Version of Ip.
     *
     * @return self
     */
    public function setIpVersion($ipVersion)
    {
        if (is_null($ipVersion)) {
            throw new \InvalidArgumentException('non-nullable ipVersion cannot be null');
        }
        $allowedValues = $this->getIpVersionAllowableValues();
        if (!in_array($ipVersion, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'ipVersion', must be one of '%s'",
                    $ipVersion,
     ...
     * Gets v4
     *
     * @return \Coderic\Contabo\Generated\Model\IpV4|null
     */
     ...
     * Sets v4
     *
     * @param \Coderic\Contabo\Generated\Model\IpV4|null $v4 v4
     *
     * @return self
     */
