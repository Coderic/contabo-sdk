...
class ListPrivateNetworkResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'instances' => '\Coderic\Contabo\Generated\Model\Instances[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('availableIps', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['availableIps'] === null) {
            $invalidProperties[] = "'availableIps' can't be null";
        }
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling ListPrivateNetworkResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling ListPrivateNetworkResponseData., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int $privateNetworkId Private Network's id
     *
     * @return self
     */
     ...
     * Sets regionName
     *
     * @param string $regionName The region where your Private Network is located
     *
     * @return self
     */
    ...
    {
        return $this->container['availableIps'];
    }

    /**
     * Sets availableIps
     *
     * @param int $availableIps The total available IPs of the Private Network
     *
     * @return self
     */
    public function setAvailableIps($availableIps)
    {
        if (is_null($availableIps)) {
            throw new \InvalidArgumentException('non-nullable availableIps cannot be null');
        }
        $this->container['availableIps'] = $availableIps;
     ...
     * Sets createdDate
     *
     * @param \DateTime $createdDate The creation date of the Private Network
     *
     * @return self
     */
     ...
     * Gets instances
     *
     * @return \Coderic\Contabo\Generated\Model\Instances[]
     */
     ...
     * Sets instances
     *
     * @param \Coderic\Contabo\Generated\Model\Instances[] $instances instances
     *
     * @return self
     */
