...
class RoleAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['roleId'] < 0)) {
            $invalidProperties[] = "invalid value for 'roleId', must be bigger than or equal to 0.";
        }
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling RoleAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling RoleAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setChangedBy($changedBy)
    {
        ...
        if ((mb_strlen($changedBy) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changedBy when calling RoleAuditResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets roleId
     *
     * @param float $roleId The identifier of the role
     *
     * @return self
     */
    public function setRoleId($roleId)
    {
        ...
        if (($roleId < 0)) {
            throw new \InvalidArgumentException('invalid value for $roleId when calling RoleAuditResponse., must be bigger than or equal to 0.');
        }
