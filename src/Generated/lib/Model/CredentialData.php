    ...
    */
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling CredentialData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling CredentialData., must be bigger than or equal to 1.');
        }
     ...
     * Sets secretKey
     *
     * @param string $secretKey Secret key ID.
     *
     * @return self
     */
     ...
     * Sets displayName
     *
     * @param string $displayName Object Storage Name.
     *
     * @return self
     */
     ...
     * Sets credentialId
     *
     * @param float $credentialId Object Storage Credential ID
     *
     * @return self
     */
    public function setCredentialId($credentialId)
    {
        if (is_null($credentialId)) {
            throw new \InvalidArgumentException('non-nullable credentialId cannot be null');
        }
