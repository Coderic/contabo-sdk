    ...
    */
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling PatchInstanceResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PatchInstanceResponseData., must be bigger than or equal to 1.');
        }
     ...
     * Sets createdDate
     *
     * @param \DateTime $createdDate Creation date of the instance
     *
     * @return self
     */
