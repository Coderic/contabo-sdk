...
/**
 * DnsZoneRecordResponse Class Doc Comment
 *
 * @category Class
 * @package  Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class DnsZoneRecordResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DnsZoneRecordResponse';
    ...
    */
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling DnsZoneRecordResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling DnsZoneRecordResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param string $name Name, if empty the zone name will be used
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DnsZoneRecordResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling DnsZoneRecordResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setData($data)
    {
        ...
        if ((mb_strlen($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling DnsZoneRecordResponse., must be bigger than or equal to 1.');
        }
