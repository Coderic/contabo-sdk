...
class InstanceDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'dataCenterSlug' => 'setDataCenterSlug',
    ...
    protected static $getters = [
        ...
        'dataCenterSlug' => 'getDataCenterSlug',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dataCenterSlug', $data ?? [], null);
        $this->setIfExists('dataCenterName', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dataCenterSlug'] === null) {
            $invalidProperties[] = "'dataCenterSlug' can't be null";
        }
        if ($this->container['dataCenterName'] === null) {
            $invalidProperties[] = "'dataCenterName' can't be null";
        }
     ...
     * Sets instanceId
     *
     * @param int $instanceId Instance id which is assigned to firewall
     *
     * @return self
     */
     ...
     * Sets regionSlug
     *
     * @param string $regionSlug Slug of the region where the instance is located.
     *
     * @return self
     */
     ...
     * Sets regionName
     *
     * @param string $regionName Name of the region where the instance is located.
     *
     * @return self
     */
    ...
    {
        return $this->container['dataCenterSlug'];
    }

    /**
     * Sets dataCenterSlug
     *
     * @param string $dataCenterSlug Slug of the data center where the instance is located.
     *
     * @return self
     */
    public function setDataCenterSlug($dataCenterSlug)
    {
        if (is_null($dataCenterSlug)) {
            throw new \InvalidArgumentException('non-nullable dataCenterSlug cannot be null');
        }
        $this->container['dataCenterSlug'] = $dataCenterSlug;
     ...
     * Sets dataCenterName
     *
     * @param string $dataCenterName Name of the data center where the instance is located.
     *
     * @return self
     */
    public function setDataCenterName($dataCenterName)
    {
        if (is_null($dataCenterName)) {
            throw new \InvalidArgumentException('non-nullable dataCenterName cannot be null');
        }
