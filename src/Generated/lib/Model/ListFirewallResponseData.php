...
class ListFirewallResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('firewallId', $data ?? [], null);
        $this->setIfExists('name', $data ?? [], null);
        $this->setIfExists('description', $data ?? [], null);
        $this->setIfExists('status', $data ?? [], null);
        $this->setIfExists('instanceStatus', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['firewallId']) < 1)) {
            $invalidProperties[] = "invalid value for 'firewallId', the character length must be bigger than or equal to 1.";
        }
        ...
        if ($this->container['updatedDate'] === null) {
            $invalidProperties[] = "'updatedDate' can't be null";
        }
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling ListFirewallResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling ListFirewallResponseData., must be bigger than or equal to 1.');
        }
     ...
     * Sets firewallId
     *
     * @param string $firewallId Your firewall id.
     *
     * @return self
     */
    public function setFirewallId($firewallId)
    {
        if (is_null($firewallId)) {
            throw new \InvalidArgumentException('non-nullable firewallId cannot be null');
        }

        if ((mb_strlen($firewallId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firewallId when calling ListFirewallResponseData., must be bigger than or equal to 1.');
        }
    ...
    {
        if (is_null($instanceStatus)) {
            throw new \InvalidArgumentException('non-nullable instanceStatus cannot be null');
        }
     ...
     * Sets createdDate
     *
     * @param \DateTime $createdDate The creation date time for the firewall
     *
     * @return self
     */
     ...
     * Sets updatedDate
     *
     * @param \DateTime $updatedDate The update date time for the firewall
     *
     * @return self
     */
    public function setUpdatedDate($updatedDate)
    {
        if (is_null($updatedDate)) {
            throw new \InvalidArgumentException('non-nullable updatedDate cannot be null');
        }
