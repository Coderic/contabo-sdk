    ...
    */
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling CancelObjectStorageResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling CancelObjectStorageResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayName($displayName)
    {
        ...
        if ((mb_strlen($displayName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling CancelObjectStorageResponseData., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($displayName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling CancelObjectStorageResponseData., must be bigger than or equal to 1.');
        }
