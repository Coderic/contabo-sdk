...
/**
 * ZoneAuditResponseData Class Doc Comment
 *
 * @category Class
 * @package  Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class ZoneAuditResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZoneAuditResponseData';
    ...
    */
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling ZoneAuditResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling ZoneAuditResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setChangedBy($changedBy)
    {
        ...
        if ((mb_strlen($changedBy) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changedBy when calling ZoneAuditResponseData., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param string $name DNS Zone name
     *
     * @return self
     */
