...
class AssignmentAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['tagId'] < 0)) {
            $invalidProperties[] = "invalid value for 'tagId', must be bigger than or equal to 0.";
        }
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling AssignmentAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling AssignmentAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setTagId($tagId)
    {
        ...
        if (($tagId < 0)) {
            throw new \InvalidArgumentException('invalid value for $tagId when calling AssignmentAuditResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setChangedBy($changedBy)
    {
        ...
        if ((mb_strlen($changedBy) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changedBy when calling AssignmentAuditResponse., must be bigger than or equal to 1.');
        }
