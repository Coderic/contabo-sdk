...
class AssignmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tagName', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['tagName']) > 255)) {
            $invalidProperties[] = "invalid value for 'tagName', the character length must be smaller than or equal to 255.";
        }
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
    ...
    {
        if (is_null($tagName)) {
            throw new \InvalidArgumentException('non-nullable tagName cannot be null');
        }
        if ((mb_strlen($tagName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tagName when calling AssignmentResponse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($tagName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tagName when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets resourceType
     *
     * @param string $resourceType Resource type. Resource type is one of `instance|image|object-storage`.
     *
     * @return self
     */
    public function setResourceType($resourceType)
    {
        ...
        if ((mb_strlen($resourceType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $resourceType when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setResourceId($resourceId)
    {
        ...
        if ((mb_strlen($resourceId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $resourceId when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setResourceName($resourceName)
    {
        ...
        if ((mb_strlen($resourceName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $resourceName when calling AssignmentResponse., must be bigger than or equal to 1.');
        }
