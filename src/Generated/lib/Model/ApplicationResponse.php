...
class ApplicationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'type' => 'setType',
        'applicationConfig' => 'setApplicationConfig',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('applicationConfig', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['applicationConfig'] === null) {
            $invalidProperties[] = "'applicationConfig' can't be null";
        }
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling ApplicationResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling ApplicationResponse., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['applicationConfig'];
    }
    ...
    public function setApplicationConfig($applicationConfig)
    {
        if (is_null($applicationConfig)) {
            throw new \InvalidArgumentException('non-nullable applicationConfig cannot be null');
        }
        $this->container['applicationConfig'] = $applicationConfig;
