...
class UpdateUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets firstName
     *
     * @param string|null $firstName The name of the user. Names may contain letters, numbers, colons, dashes, and underscores. There is a limit of 255 characters per user.
     *
     * @return self
     */
    public function setFirstName($firstName)
    {
        ...
        if ((mb_strlen($firstName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling UpdateUserRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($firstName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling UpdateUserRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets lastName
     *
     * @param string|null $lastName The last name of the user. Users may contain letters, numbers, colons, dashes, and underscores. There is a limit of 255 characters per user.
     *
     * @return self
     */
    public function setLastName($lastName)
    {
        ...
        if ((mb_strlen($lastName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling UpdateUserRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($lastName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling UpdateUserRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets locale
     *
     * @param string|null $locale The locale of the user. This can be `de-DE`, `de`, `en-US`, `en`, `es-ES`, `es`, `pt-BR`, `pt`.
     *
     * @return self
     */
