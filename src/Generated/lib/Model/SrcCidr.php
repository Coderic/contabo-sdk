...
class SrcCidr implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets ipv4
     *
     * @param string[]|null $ipv4 IPv4 addresses in CIDR notation or \"AnyIPv4\" to allow all IPv4 sources (translates to 0.0.0.0/0)
     *
     * @return self
     */
     ...
     * Sets ipv6
     *
     * @param string[]|null $ipv6 IPv6 addresses in CIDR notation or \"AnyIPv6\" to allow all IPv6 sources (translates to ::/0)
     *
     * @return self
     */
