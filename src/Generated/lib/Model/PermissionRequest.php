...
class PermissionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['apiName']) > 255)) {
            $invalidProperties[] = "invalid value for 'apiName', the character length must be smaller than or equal to 255.";
        }
     ...
     * Sets apiName
     *
     * @param string $apiName The name of the role. There is a limit of 255 characters per role.
     *
     * @return self
     */
    public function setApiName($apiName)
    {
        ...
        if ((mb_strlen($apiName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $apiName when calling PermissionRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($apiName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $apiName when calling PermissionRequest., must be bigger than or equal to 1.');
        }
