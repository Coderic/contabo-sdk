...
class Instances implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'privateIpConfig' => 'setPrivateIpConfig',
    ...
    protected static $getters = [
        ...
        'privateIpConfig' => 'getPrivateIpConfig',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('privateIpConfig', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['privateIpConfig'] === null) {
            $invalidProperties[] = "'privateIpConfig' can't be null";
        }
    ...
    {
        return $this->container['privateIpConfig'];
    }
     ...
     * @return self
     */
    public function setPrivateIpConfig($privateIpConfig)
    {
        if (is_null($privateIpConfig)) {
            throw new \InvalidArgumentException('non-nullable privateIpConfig cannot be null');
        }
        $this->container['privateIpConfig'] = $privateIpConfig;
