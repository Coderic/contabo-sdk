...
/**
 * RecordAuditResponseData Class Doc Comment
 *
 * @category Class
 * @package  Contabo\Generated
 * @author   OpenAPI Generator team
 ...
 */
class RecordAuditResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecordAuditResponseData';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('zoneName', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['recordId'] < 0)) {
            $invalidProperties[] = "invalid value for 'recordId', must be bigger than or equal to 0.";
        }
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling RecordAuditResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling RecordAuditResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setChangedBy($changedBy)
    {
        ...
        if ((mb_strlen($changedBy) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changedBy when calling RecordAuditResponseData., must be bigger than or equal to 1.');
        }
     ...
     * Sets recordId
     *
     * @param int $recordId The identifier of the Zone recordd
     *
     * @return self
     */
    public function setRecordId($recordId)
    {
        ...
        if (($recordId < 0)) {
            throw new \InvalidArgumentException('invalid value for $recordId when calling RecordAuditResponseData., must be bigger than or equal to 0.');
        }
     ...
     * Sets zoneName
     *
     * @param string $zoneName DNS Zone name
     *
     * @return self
     */
    ...
    {
        if (is_null($zoneName)) {
            throw new \InvalidArgumentException('non-nullable zoneName cannot be null');
        }
