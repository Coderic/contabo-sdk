    ...
    */
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling FirewallResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling FirewallResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setFirewallId($firewallId)
    {
        ...
        if ((mb_strlen($firewallId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firewallId when calling FirewallResponse., must be bigger than or equal to 1.');
        }
