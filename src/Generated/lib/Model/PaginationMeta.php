...
class PaginationMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['totalElements'] === null) {
            $invalidProperties[] = "'totalElements' can't be null";
        }
     ...
     * Sets totalElements
     *
     * @param float $totalElements Number of overall matched elements.
     *
     * @return self
     */
     ...
     * Sets totalPages
     *
     * @param float $totalPages Overall number of pages.
     *
     * @return self
     */
