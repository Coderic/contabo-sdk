    ...
    */
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling InstancesAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling InstancesAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setChangedBy($changedBy)
    {
        ...
        if ((mb_strlen($changedBy) < 1)) {
            throw new \InvalidArgumentException('invalid length for $changedBy when calling InstancesAuditResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setInstanceId($instanceId)
    {
        ...
        if (($instanceId < 0)) {
            throw new \InvalidArgumentException('invalid value for $instanceId when calling InstancesAuditResponse., must be bigger than or equal to 0.');
        }
