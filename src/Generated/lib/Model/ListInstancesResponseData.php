    ...
    */
    ...
    public function setTenantId($tenantId)
    {
        ...
        if ((mb_strlen($tenantId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tenantId when calling ListInstancesResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling ListInstancesResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setCancelDate($cancelDate)
    {
        ...
        if ((mb_strlen($cancelDate) > 10)) {
            throw new \InvalidArgumentException('invalid length for $cancelDate when calling ListInstancesResponseData., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($cancelDate) < 0)) {
            throw new \InvalidArgumentException('invalid length for $cancelDate when calling ListInstancesResponseData., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/yyyy-mm-dd/", ObjectSerializer::toString($cancelDate)))) {
            throw new \InvalidArgumentException("invalid value for \$cancelDate when calling ListInstancesResponseData., must conform to the pattern /yyyy-mm-dd/.");
        }
