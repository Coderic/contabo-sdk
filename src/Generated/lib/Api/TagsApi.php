...
class TagsApi
{
    ...
    {
        list($response) = $this->createTagWithHttpInfo($xRequestId, $createTagRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     */
    public function createTagAsync($xRequestId, $createTagRequest, $xTraceId = null, string $contentType = self::contentTypes['createTag'][0])
    {
        return $this->createTagAsyncWithHttpInfo($xRequestId, $createTagRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function createTagRequest($xRequestId, $createTagRequest, $xTraceId = null, string $contentType = self::contentTypes['createTag'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling createTag'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling TagsApi.createTag, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'createTagRequest' is set
        if ($createTagRequest === null || (is_array($createTagRequest) && count($createTagRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $createTagRequest when calling createTag'
            );
        }
        ...
        // for model (json/xml)
        if (isset($createTagRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($createTagRequest));
            } else {
                $httpBody = $createTagRequest;
            }
     ...
     * @return void
     */
    public function deleteTag($xRequestId, $tagId, $xTraceId = null, string $contentType = self::contentTypes['deleteTag'][0])
    {
        $this->deleteTagWithHttpInfo($xRequestId, $tagId, $xTraceId, $contentType);
    }
     ...
     */
    public function deleteTagWithHttpInfo($xRequestId, $tagId, $xTraceId = null, string $contentType = self::contentTypes['deleteTag'][0])
    {
        $request = $this->deleteTagRequest($xRequestId, $tagId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTagAsync($xRequestId, $tagId, $xTraceId = null, string $contentType = self::contentTypes['deleteTag'][0])
    {
        return $this->deleteTagAsyncWithHttpInfo($xRequestId, $tagId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTagAsyncWithHttpInfo($xRequestId, $tagId, $xTraceId = null, string $contentType = self::contentTypes['deleteTag'][0])
    {
        $returnType = '';
        $request = $this->deleteTagRequest($xRequestId, $tagId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteTagRequest($xRequestId, $tagId, $xTraceId = null, string $contentType = self::contentTypes['deleteTag'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling deleteTag'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling TagsApi.deleteTag, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->retrieveTagWithHttpInfo($xRequestId, $tagId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveTagAsync($xRequestId, $tagId, $xTraceId = null, string $contentType = self::contentTypes['retrieveTag'][0])
    {
        return $this->retrieveTagAsyncWithHttpInfo($xRequestId, $tagId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveTagRequest($xRequestId, $tagId, $xTraceId = null, string $contentType = self::contentTypes['retrieveTag'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveTag'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling TagsApi.retrieveTag, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'tagId' is set
        if ($tagId === null || (is_array($tagId) && count($tagId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tagId when calling retrieveTag'
            );
        }
    ...
    {
        list($response) = $this->retrieveTagListWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveTagListAsync($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, string $contentType = self::contentTypes['retrieveTagList'][0])
    {
        return $this->retrieveTagListAsyncWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveTagListRequest($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, string $contentType = self::contentTypes['retrieveTagList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveTagList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling TagsApi.retrieveTagList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->updateTagWithHttpInfo($xRequestId, $tagId, $updateTagRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTagAsync($xRequestId, $tagId, $updateTagRequest, $xTraceId = null, string $contentType = self::contentTypes['updateTag'][0])
    {
        return $this->updateTagAsyncWithHttpInfo($xRequestId, $tagId, $updateTagRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTagRequest($xRequestId, $tagId, $updateTagRequest, $xTraceId = null, string $contentType = self::contentTypes['updateTag'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling updateTag'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling TagsApi.updateTag, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        ...
        if ($updateTagRequest === null || (is_array($updateTagRequest) && count($updateTagRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $updateTagRequest when calling updateTag'
            );
        }
        ...
        // for model (json/xml)
        if (isset($updateTagRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($updateTagRequest));
            } else {
                $httpBody = $updateTagRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
