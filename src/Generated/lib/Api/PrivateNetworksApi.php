...
class PrivateNetworksApi
{
    ...
    {
        list($response) = $this->assignInstancePrivateNetworkWithHttpInfo($xRequestId, $privateNetworkId, $instanceId, $xTraceId, $contentType);
        return $response;
    }
     ...
     */
    public function assignInstancePrivateNetworkAsync($xRequestId, $privateNetworkId, $instanceId, $xTraceId = null, string $contentType = self::contentTypes['assignInstancePrivateNetwork'][0])
    {
        return $this->assignInstancePrivateNetworkAsyncWithHttpInfo($xRequestId, $privateNetworkId, $instanceId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function assignInstancePrivateNetworkRequest($xRequestId, $privateNetworkId, $instanceId, $xTraceId = null, string $contentType = self::contentTypes['assignInstancePrivateNetwork'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling assignInstancePrivateNetwork'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling PrivateNetworksApi.assignInstancePrivateNetwork, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'privateNetworkId' is set
        if ($privateNetworkId === null || (is_array($privateNetworkId) && count($privateNetworkId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $privateNetworkId when calling assignInstancePrivateNetwork'
            );
        }
        ...
        if ($instanceId === null || (is_array($instanceId) && count($instanceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instanceId when calling assignInstancePrivateNetwork'
            );
        }
        ...
        if ($privateNetworkId !== null) {
            $resourcePath = str_replace(
                '{' . 'privateNetworkId' . '}',
                ObjectSerializer::toPathValue($privateNetworkId),
                $resourcePath
            );
        }
        // path params
    ...
    {
        list($response) = $this->createPrivateNetworkWithHttpInfo($xRequestId, $createPrivateNetworkRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPrivateNetworkAsync($xRequestId, $createPrivateNetworkRequest, $xTraceId = null, string $contentType = self::contentTypes['createPrivateNetwork'][0])
    {
        return $this->createPrivateNetworkAsyncWithHttpInfo($xRequestId, $createPrivateNetworkRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createPrivateNetworkRequest($xRequestId, $createPrivateNetworkRequest, $xTraceId = null, string $contentType = self::contentTypes['createPrivateNetwork'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling createPrivateNetwork'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling PrivateNetworksApi.createPrivateNetwork, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'createPrivateNetworkRequest' is set
        if ($createPrivateNetworkRequest === null || (is_array($createPrivateNetworkRequest) && count($createPrivateNetworkRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $createPrivateNetworkRequest when calling createPrivateNetwork'
            );
        }
        ...
        // for model (json/xml)
        if (isset($createPrivateNetworkRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($createPrivateNetworkRequest));
            } else {
                $httpBody = $createPrivateNetworkRequest;
            }
     ...
     * @return void
     */
    public function deletePrivateNetwork($xRequestId, $privateNetworkId, $xTraceId = null, string $contentType = self::contentTypes['deletePrivateNetwork'][0])
    {
        $this->deletePrivateNetworkWithHttpInfo($xRequestId, $privateNetworkId, $xTraceId, $contentType);
    }
     ...
     */
    public function deletePrivateNetworkWithHttpInfo($xRequestId, $privateNetworkId, $xTraceId = null, string $contentType = self::contentTypes['deletePrivateNetwork'][0])
    {
        $request = $this->deletePrivateNetworkRequest($xRequestId, $privateNetworkId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletePrivateNetworkAsync($xRequestId, $privateNetworkId, $xTraceId = null, string $contentType = self::contentTypes['deletePrivateNetwork'][0])
    {
        return $this->deletePrivateNetworkAsyncWithHttpInfo($xRequestId, $privateNetworkId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletePrivateNetworkAsyncWithHttpInfo($xRequestId, $privateNetworkId, $xTraceId = null, string $contentType = self::contentTypes['deletePrivateNetwork'][0])
    {
        $returnType = '';
        $request = $this->deletePrivateNetworkRequest($xRequestId, $privateNetworkId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deletePrivateNetworkRequest($xRequestId, $privateNetworkId, $xTraceId = null, string $contentType = self::contentTypes['deletePrivateNetwork'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling deletePrivateNetwork'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling PrivateNetworksApi.deletePrivateNetwork, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'privateNetworkId' is set
        if ($privateNetworkId === null || (is_array($privateNetworkId) && count($privateNetworkId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $privateNetworkId when calling deletePrivateNetwork'
            );
        }
    ...
    {
        list($response) = $this->patchPrivateNetworkWithHttpInfo($xRequestId, $privateNetworkId, $patchPrivateNetworkRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchPrivateNetworkAsync($xRequestId, $privateNetworkId, $patchPrivateNetworkRequest, $xTraceId = null, string $contentType = self::contentTypes['patchPrivateNetwork'][0])
    {
        return $this->patchPrivateNetworkAsyncWithHttpInfo($xRequestId, $privateNetworkId, $patchPrivateNetworkRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPrivateNetworkRequest($xRequestId, $privateNetworkId, $patchPrivateNetworkRequest, $xTraceId = null, string $contentType = self::contentTypes['patchPrivateNetwork'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling patchPrivateNetwork'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling PrivateNetworksApi.patchPrivateNetwork, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'privateNetworkId' is set
        if ($privateNetworkId === null || (is_array($privateNetworkId) && count($privateNetworkId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $privateNetworkId when calling patchPrivateNetwork'
            );
        }

        // verify the required parameter 'patchPrivateNetworkRequest' is set
        if ($patchPrivateNetworkRequest === null || (is_array($patchPrivateNetworkRequest) && count($patchPrivateNetworkRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $patchPrivateNetworkRequest when calling patchPrivateNetwork'
            );
        }
        ...
        // for model (json/xml)
        if (isset($patchPrivateNetworkRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($patchPrivateNetworkRequest));
            } else {
                $httpBody = $patchPrivateNetworkRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    {
        list($response) = $this->retrievePrivateNetworkWithHttpInfo($xRequestId, $privateNetworkId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePrivateNetworkAsync($xRequestId, $privateNetworkId, $xTraceId = null, string $contentType = self::contentTypes['retrievePrivateNetwork'][0])
    {
        return $this->retrievePrivateNetworkAsyncWithHttpInfo($xRequestId, $privateNetworkId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePrivateNetworkRequest($xRequestId, $privateNetworkId, $xTraceId = null, string $contentType = self::contentTypes['retrievePrivateNetwork'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrievePrivateNetwork'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling PrivateNetworksApi.retrievePrivateNetwork, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'privateNetworkId' is set
        if ($privateNetworkId === null || (is_array($privateNetworkId) && count($privateNetworkId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $privateNetworkId when calling retrievePrivateNetwork'
            );
        }
     ...
     * @param  string|null $name The name of the Private Network (optional)
     * @param  string|null $instanceIds Comma separated instances identifiers (optional)
     * @param  string|null $region The slug of the region where your Private Network is located (optional)
    ...
    {
        list($response) = $this->retrievePrivateNetworkListWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $instanceIds, $region, $dataCenter, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrievePrivateNetworkListAsync($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, $instanceIds = null, $region = null, $dataCenter = null, string $contentType = self::contentTypes['retrievePrivateNetworkList'][0])
    {
        return $this->retrievePrivateNetworkListAsyncWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $instanceIds, $region, $dataCenter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievePrivateNetworkListRequest($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, $instanceIds = null, $region = null, $dataCenter = null, string $contentType = self::contentTypes['retrievePrivateNetworkList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrievePrivateNetworkList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling PrivateNetworksApi.retrievePrivateNetworkList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->unassignInstancePrivateNetworkWithHttpInfo($xRequestId, $privateNetworkId, $instanceId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unassignInstancePrivateNetworkAsync($xRequestId, $privateNetworkId, $instanceId, $xTraceId = null, string $contentType = self::contentTypes['unassignInstancePrivateNetwork'][0])
    {
        return $this->unassignInstancePrivateNetworkAsyncWithHttpInfo($xRequestId, $privateNetworkId, $instanceId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function unassignInstancePrivateNetworkRequest($xRequestId, $privateNetworkId, $instanceId, $xTraceId = null, string $contentType = self::contentTypes['unassignInstancePrivateNetwork'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling unassignInstancePrivateNetwork'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling PrivateNetworksApi.unassignInstancePrivateNetwork, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'privateNetworkId' is set
        if ($privateNetworkId === null || (is_array($privateNetworkId) && count($privateNetworkId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $privateNetworkId when calling unassignInstancePrivateNetwork'
            );
        }
        ...
        if ($instanceId === null || (is_array($instanceId) && count($instanceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instanceId when calling unassignInstancePrivateNetwork'
            );
        }
