...
class UsersApi
{
    ...
    {
        list($response) = $this->createUserWithHttpInfo($xRequestId, $createUserRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     */
    public function createUserAsync($xRequestId, $createUserRequest, $xTraceId = null, string $contentType = self::contentTypes['createUser'][0])
    {
        return $this->createUserAsyncWithHttpInfo($xRequestId, $createUserRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function createUserRequest($xRequestId, $createUserRequest, $xTraceId = null, string $contentType = self::contentTypes['createUser'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling createUser'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersApi.createUser, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
     ...
     * @return void
     */
    public function deleteUser($xRequestId, $userId, $xTraceId = null, string $contentType = self::contentTypes['deleteUser'][0])
    {
        $this->deleteUserWithHttpInfo($xRequestId, $userId, $xTraceId, $contentType);
    }
     ...
     */
    public function deleteUserWithHttpInfo($xRequestId, $userId, $xTraceId = null, string $contentType = self::contentTypes['deleteUser'][0])
    {
        $request = $this->deleteUserRequest($xRequestId, $userId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteUserAsync($xRequestId, $userId, $xTraceId = null, string $contentType = self::contentTypes['deleteUser'][0])
    {
        return $this->deleteUserAsyncWithHttpInfo($xRequestId, $userId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteUserAsyncWithHttpInfo($xRequestId, $userId, $xTraceId = null, string $contentType = self::contentTypes['deleteUser'][0])
    {
        $returnType = '';
        $request = $this->deleteUserRequest($xRequestId, $userId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteUserRequest($xRequestId, $userId, $xTraceId = null, string $contentType = self::contentTypes['deleteUser'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling deleteUser'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersApi.deleteUser, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->generateClientSecretWithHttpInfo($xRequestId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateClientSecretAsync($xRequestId, $xTraceId = null, string $contentType = self::contentTypes['generateClientSecret'][0])
    {
        return $this->generateClientSecretAsyncWithHttpInfo($xRequestId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function generateClientSecretRequest($xRequestId, $xTraceId = null, string $contentType = self::contentTypes['generateClientSecret'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling generateClientSecret'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersApi.generateClientSecret, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
     ...
     * @return void
     */
    public function resendEmailVerification($xRequestId, $userId, $xTraceId = null, $redirectUrl = null, string $contentType = self::contentTypes['resendEmailVerification'][0])
    {
        $this->resendEmailVerificationWithHttpInfo($xRequestId, $userId, $xTraceId, $redirectUrl, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function resendEmailVerificationWithHttpInfo($xRequestId, $userId, $xTraceId = null, $redirectUrl = null, string $contentType = self::contentTypes['resendEmailVerification'][0])
    {
        $request = $this->resendEmailVerificationRequest($xRequestId, $userId, $xTraceId, $redirectUrl, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resendEmailVerificationAsync($xRequestId, $userId, $xTraceId = null, $redirectUrl = null, string $contentType = self::contentTypes['resendEmailVerification'][0])
    {
        return $this->resendEmailVerificationAsyncWithHttpInfo($xRequestId, $userId, $xTraceId, $redirectUrl, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resendEmailVerificationAsyncWithHttpInfo($xRequestId, $userId, $xTraceId = null, $redirectUrl = null, string $contentType = self::contentTypes['resendEmailVerification'][0])
    {
        $returnType = '';
        $request = $this->resendEmailVerificationRequest($xRequestId, $userId, $xTraceId, $redirectUrl, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resendEmailVerificationRequest($xRequestId, $userId, $xTraceId = null, $redirectUrl = null, string $contentType = self::contentTypes['resendEmailVerification'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling resendEmailVerification'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersApi.resendEmailVerification, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'userId' is set
        if ($userId === null || (is_array($userId) && count($userId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $userId when calling resendEmailVerification'
            );
        }
     ...
     * @return void
     */
    public function resetPassword($xRequestId, $userId, $xTraceId = null, $redirectUrl = null, string $contentType = self::contentTypes['resetPassword'][0])
    {
        $this->resetPasswordWithHttpInfo($xRequestId, $userId, $xTraceId, $redirectUrl, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function resetPasswordWithHttpInfo($xRequestId, $userId, $xTraceId = null, $redirectUrl = null, string $contentType = self::contentTypes['resetPassword'][0])
    {
        $request = $this->resetPasswordRequest($xRequestId, $userId, $xTraceId, $redirectUrl, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetPasswordAsync($xRequestId, $userId, $xTraceId = null, $redirectUrl = null, string $contentType = self::contentTypes['resetPassword'][0])
    {
        return $this->resetPasswordAsyncWithHttpInfo($xRequestId, $userId, $xTraceId, $redirectUrl, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetPasswordAsyncWithHttpInfo($xRequestId, $userId, $xTraceId = null, $redirectUrl = null, string $contentType = self::contentTypes['resetPassword'][0])
    {
        $returnType = '';
        $request = $this->resetPasswordRequest($xRequestId, $userId, $xTraceId, $redirectUrl, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resetPasswordRequest($xRequestId, $userId, $xTraceId = null, $redirectUrl = null, string $contentType = self::contentTypes['resetPassword'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling resetPassword'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersApi.resetPassword, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->retrieveUserWithHttpInfo($xRequestId, $userId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveUserAsync($xRequestId, $userId, $xTraceId = null, string $contentType = self::contentTypes['retrieveUser'][0])
    {
        return $this->retrieveUserAsyncWithHttpInfo($xRequestId, $userId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveUserRequest($xRequestId, $userId, $xTraceId = null, string $contentType = self::contentTypes['retrieveUser'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveUser'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersApi.retrieveUser, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'userId' is set
        if ($userId === null || (is_array($userId) && count($userId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $userId when calling retrieveUser'
            );
        }
    ...
    {
        list($response) = $this->retrieveUserClientWithHttpInfo($xRequestId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveUserClientAsync($xRequestId, $xTraceId = null, string $contentType = self::contentTypes['retrieveUserClient'][0])
    {
        return $this->retrieveUserClientAsyncWithHttpInfo($xRequestId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveUserClientRequest($xRequestId, $xTraceId = null, string $contentType = self::contentTypes['retrieveUserClient'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveUserClient'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersApi.retrieveUserClient, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->retrieveUserIsPasswordSetWithHttpInfo($xRequestId, $xTraceId, $userId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveUserIsPasswordSetAsync($xRequestId, $xTraceId = null, $userId = null, string $contentType = self::contentTypes['retrieveUserIsPasswordSet'][0])
    {
        return $this->retrieveUserIsPasswordSetAsyncWithHttpInfo($xRequestId, $xTraceId, $userId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveUserIsPasswordSetRequest($xRequestId, $xTraceId = null, $userId = null, string $contentType = self::contentTypes['retrieveUserIsPasswordSet'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveUserIsPasswordSet'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersApi.retrieveUserIsPasswordSet, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
     ...
     * @param  string|null $email Filter as substring match for user emails. (optional)
     * @param  bool|null $enabled Filter if user is enabled or not. (optional)
    ...
    {
        list($response) = $this->retrieveUserListWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $email, $enabled, $owner, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveUserListAsync($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $email = null, $enabled = null, $owner = null, string $contentType = self::contentTypes['retrieveUserList'][0])
    {
        return $this->retrieveUserListAsyncWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $email, $enabled, $owner, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveUserListRequest($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $email = null, $enabled = null, $owner = null, string $contentType = self::contentTypes['retrieveUserList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveUserList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersApi.retrieveUserList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->updateUserWithHttpInfo($xRequestId, $userId, $updateUserRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateUserAsync($xRequestId, $userId, $updateUserRequest, $xTraceId = null, string $contentType = self::contentTypes['updateUser'][0])
    {
        return $this->updateUserAsyncWithHttpInfo($xRequestId, $userId, $updateUserRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateUserRequest($xRequestId, $userId, $updateUserRequest, $xTraceId = null, string $contentType = self::contentTypes['updateUser'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling updateUser'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersApi.updateUser, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
