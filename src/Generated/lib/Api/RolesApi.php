...
class RolesApi
{
    ...
    {
        list($response) = $this->createRoleWithHttpInfo($xRequestId, $createRoleRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     */
    public function createRoleAsync($xRequestId, $createRoleRequest, $xTraceId = null, string $contentType = self::contentTypes['createRole'][0])
    {
        return $this->createRoleAsyncWithHttpInfo($xRequestId, $createRoleRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function createRoleRequest($xRequestId, $createRoleRequest, $xTraceId = null, string $contentType = self::contentTypes['createRole'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling createRole'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling RolesApi.createRole, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
     ...
     * @return void
     */
    public function deleteRole($xRequestId, $roleId, $xTraceId = null, string $contentType = self::contentTypes['deleteRole'][0])
    {
        $this->deleteRoleWithHttpInfo($xRequestId, $roleId, $xTraceId, $contentType);
    }
     ...
     */
    public function deleteRoleWithHttpInfo($xRequestId, $roleId, $xTraceId = null, string $contentType = self::contentTypes['deleteRole'][0])
    {
        $request = $this->deleteRoleRequest($xRequestId, $roleId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteRoleAsync($xRequestId, $roleId, $xTraceId = null, string $contentType = self::contentTypes['deleteRole'][0])
    {
        return $this->deleteRoleAsyncWithHttpInfo($xRequestId, $roleId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteRoleAsyncWithHttpInfo($xRequestId, $roleId, $xTraceId = null, string $contentType = self::contentTypes['deleteRole'][0])
    {
        $returnType = '';
        $request = $this->deleteRoleRequest($xRequestId, $roleId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteRoleRequest($xRequestId, $roleId, $xTraceId = null, string $contentType = self::contentTypes['deleteRole'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling deleteRole'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling RolesApi.deleteRole, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->retrieveApiPermissionsListWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $apiName, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveApiPermissionsListAsync($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $apiName = null, string $contentType = self::contentTypes['retrieveApiPermissionsList'][0])
    {
        return $this->retrieveApiPermissionsListAsyncWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $apiName, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveApiPermissionsListRequest($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $apiName = null, string $contentType = self::contentTypes['retrieveApiPermissionsList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveApiPermissionsList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling RolesApi.retrieveApiPermissionsList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->retrieveRoleWithHttpInfo($xRequestId, $roleId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveRoleAsync($xRequestId, $roleId, $xTraceId = null, string $contentType = self::contentTypes['retrieveRole'][0])
    {
        return $this->retrieveRoleAsyncWithHttpInfo($xRequestId, $roleId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveRoleRequest($xRequestId, $roleId, $xTraceId = null, string $contentType = self::contentTypes['retrieveRole'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveRole'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling RolesApi.retrieveRole, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
     ...
     * @param  int|null $size Number of elements per page. (optional)
     * @param  string[]|null $orderBy Specify fields and ordering (ASC for ascending, DESC for descending) in following format &#x60;field:ASC|DESC&#x60;. (optional)
     * @param  string|null $name The name of the role (optional)
     * @param  string|null $apiName The name of api (optional)
     * @param  string|null $tagName The name of the tag (optional)
    ...
    {
        list($response) = $this->retrieveRoleListWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $apiName, $tagName, $type, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveRoleListAsync($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, $apiName = null, $tagName = null, $type = null, string $contentType = self::contentTypes['retrieveRoleList'][0])
    {
        return $this->retrieveRoleListAsyncWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $apiName, $tagName, $type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveRoleListRequest($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, $apiName = null, $tagName = null, $type = null, string $contentType = self::contentTypes['retrieveRoleList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveRoleList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling RolesApi.retrieveRoleList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->updateRoleWithHttpInfo($xRequestId, $roleId, $updateRoleRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateRoleAsync($xRequestId, $roleId, $updateRoleRequest, $xTraceId = null, string $contentType = self::contentTypes['updateRole'][0])
    {
        return $this->updateRoleAsyncWithHttpInfo($xRequestId, $roleId, $updateRoleRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRoleRequest($xRequestId, $roleId, $updateRoleRequest, $xTraceId = null, string $contentType = self::contentTypes['updateRole'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling updateRole'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling RolesApi.updateRole, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
