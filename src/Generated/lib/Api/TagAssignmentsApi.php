...
class TagAssignmentsApi
{
     ...
     * @param  string $resourceType The identifier of the resource type. Resource type is one of &#x60;instance|image|object-storage&#x60;. (required)
     * @param  string $resourceId The identifier of the resource id (required)
    ...
    {
        list($response) = $this->createAssignmentWithHttpInfo($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId, $contentType);
        return $response;
    }
     ...
     */
    public function createAssignmentAsync($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId = null, string $contentType = self::contentTypes['createAssignment'][0])
    {
        return $this->createAssignmentAsyncWithHttpInfo($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function createAssignmentRequest($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId = null, string $contentType = self::contentTypes['createAssignment'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling createAssignment'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling TagAssignmentsApi.createAssignment, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'tagId' is set
        if ($tagId === null || (is_array($tagId) && count($tagId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tagId when calling createAssignment'
            );
        }
        ...
        if ($resourceType === null || (is_array($resourceType) && count($resourceType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $resourceType when calling createAssignment'
            );
        }
        ...
        if ($resourceId === null || (is_array($resourceId) && count($resourceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $resourceId when calling createAssignment'
            );
        }
     ...
     * @return void
     */
    public function deleteAssignment($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId = null, string $contentType = self::contentTypes['deleteAssignment'][0])
    {
        $this->deleteAssignmentWithHttpInfo($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId, $contentType);
    }
     ...
     */
    public function deleteAssignmentWithHttpInfo($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId = null, string $contentType = self::contentTypes['deleteAssignment'][0])
    {
        $request = $this->deleteAssignmentRequest($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAssignmentAsync($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId = null, string $contentType = self::contentTypes['deleteAssignment'][0])
    {
        return $this->deleteAssignmentAsyncWithHttpInfo($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAssignmentAsyncWithHttpInfo($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId = null, string $contentType = self::contentTypes['deleteAssignment'][0])
    {
        $returnType = '';
        $request = $this->deleteAssignmentRequest($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteAssignmentRequest($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId = null, string $contentType = self::contentTypes['deleteAssignment'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling deleteAssignment'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling TagAssignmentsApi.deleteAssignment, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'tagId' is set
        if ($tagId === null || (is_array($tagId) && count($tagId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tagId when calling deleteAssignment'
            );
        }
        ...
        if ($resourceType === null || (is_array($resourceType) && count($resourceType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $resourceType when calling deleteAssignment'
            );
        }
        ...
        if ($resourceId === null || (is_array($resourceId) && count($resourceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $resourceId when calling deleteAssignment'
            );
        }
    ...
    {
        list($response) = $this->retrieveAssignmentWithHttpInfo($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAssignmentAsync($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId = null, string $contentType = self::contentTypes['retrieveAssignment'][0])
    {
        return $this->retrieveAssignmentAsyncWithHttpInfo($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveAssignmentRequest($xRequestId, $tagId, $resourceType, $resourceId, $xTraceId = null, string $contentType = self::contentTypes['retrieveAssignment'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveAssignment'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling TagAssignmentsApi.retrieveAssignment, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'tagId' is set
        if ($tagId === null || (is_array($tagId) && count($tagId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tagId when calling retrieveAssignment'
            );
        }
        ...
        if ($resourceType === null || (is_array($resourceType) && count($resourceType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $resourceType when calling retrieveAssignment'
            );
        }
        ...
        if ($resourceId === null || (is_array($resourceId) && count($resourceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $resourceId when calling retrieveAssignment'
            );
        }
    ...
    {
        list($response) = $this->retrieveAssignmentListWithHttpInfo($xRequestId, $tagId, $xTraceId, $page, $size, $orderBy, $resourceType, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAssignmentListAsync($xRequestId, $tagId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $resourceType = null, string $contentType = self::contentTypes['retrieveAssignmentList'][0])
    {
        return $this->retrieveAssignmentListAsyncWithHttpInfo($xRequestId, $tagId, $xTraceId, $page, $size, $orderBy, $resourceType, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveAssignmentListRequest($xRequestId, $tagId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $resourceType = null, string $contentType = self::contentTypes['retrieveAssignmentList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveAssignmentList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling TagAssignmentsApi.retrieveAssignmentList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'tagId' is set
        if ($tagId === null || (is_array($tagId) && count($tagId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tagId when calling retrieveAssignmentList'
            );
        }
