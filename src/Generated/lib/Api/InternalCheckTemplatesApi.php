 ...
 * @link     https://openapi-generator.tech
 */
class InternalCheckTemplatesApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  float $checkTemplateId Check template&#39;s id (required)
    ...
    {
        list($response) = $this->getCheckTemplateWithHttpInfo($xRequestId, $orgId, $checkTemplateId, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation getCheckTemplateWithHttpInfo
     *
     * Get check
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation getCheckTemplateAsync
     *
     * Get check
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     */
    public function getCheckTemplateAsync($xRequestId, $orgId, $checkTemplateId, $xTraceId = null, string $contentType = self::contentTypes['getCheckTemplate'][0])
    {
        return $this->getCheckTemplateAsyncWithHttpInfo($xRequestId, $orgId, $checkTemplateId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCheckTemplateAsyncWithHttpInfo
     *
     * Get check
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'getCheckTemplate'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  string $orgId Org ID (required)
     * @param  float $checkTemplateId Check template&#39;s id (required)
     ...
     */
    public function getCheckTemplateRequest($xRequestId, $orgId, $checkTemplateId, $xTraceId = null, string $contentType = self::contentTypes['getCheckTemplate'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling getCheckTemplate'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalCheckTemplatesApi.getCheckTemplate, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'orgId' is set
        if ($orgId === null || (is_array($orgId) && count($orgId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgId when calling getCheckTemplate'
            );
        }

        // verify the required parameter 'checkTemplateId' is set
        if ($checkTemplateId === null || (is_array($checkTemplateId) && count($checkTemplateId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkTemplateId when calling getCheckTemplate'
            );
        }



        $resourcePath = '/internal/v1/troubleshooting/check-templates/{orgId}/{checkTemplateId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($checkTemplateId !== null) {
            $resourcePath = str_replace(
                '{' . 'checkTemplateId' . '}',
                ObjectSerializer::toPathValue($checkTemplateId),
                $resourcePath
            );
        }
     ...
     * @param  string|null $collectorClass Class used to collect the required information for the check (optional)
    ...
    {
        list($response) = $this->listCheckTemplatesWithHttpInfo($xRequestId, $orgIds, $xTraceId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $modificationStartTime, $modificationEndTime, $accountId, $internal, $objectType, $collectorClass, $checkClass, $contentType);
        return $response;
    }

    /**
     * Operation listCheckTemplatesWithHttpInfo
     *
     * List check templates
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation listCheckTemplatesAsync
     *
     * List check templates
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCheckTemplatesAsync($xRequestId, $orgIds, $xTraceId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $modificationStartTime = null, $modificationEndTime = null, $accountId = null, $internal = null, $objectType = null, $collectorClass = null, $checkClass = null, string $contentType = self::contentTypes['listCheckTemplates'][0])
    {
        return $this->listCheckTemplatesAsyncWithHttpInfo($xRequestId, $orgIds, $xTraceId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $modificationStartTime, $modificationEndTime, $accountId, $internal, $objectType, $collectorClass, $checkClass, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listCheckTemplatesAsyncWithHttpInfo
     *
     * List check templates
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'listCheckTemplates'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  string[] $orgIds Org IDs (required)
     * @param  string|null $xTraceId Identifier to trace group of requests. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listCheckTemplatesRequest($xRequestId, $orgIds, $xTraceId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $modificationStartTime = null, $modificationEndTime = null, $accountId = null, $internal = null, $objectType = null, $collectorClass = null, $checkClass = null, string $contentType = self::contentTypes['listCheckTemplates'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling listCheckTemplates'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalCheckTemplatesApi.listCheckTemplates, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'orgIds' is set
        if ($orgIds === null || (is_array($orgIds) && count($orgIds) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgIds when calling listCheckTemplates'
            );
        }
        ...
        $resourcePath = '/internal/v1/troubleshooting/check-templates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
