...
class ImagesApi
{
    ...
    {
        list($response) = $this->createCustomImageWithHttpInfo($xRequestId, $createCustomImageRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     */
    public function createCustomImageAsync($xRequestId, $createCustomImageRequest, $xTraceId = null, string $contentType = self::contentTypes['createCustomImage'][0])
    {
        return $this->createCustomImageAsyncWithHttpInfo($xRequestId, $createCustomImageRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function createCustomImageRequest($xRequestId, $createCustomImageRequest, $xTraceId = null, string $contentType = self::contentTypes['createCustomImage'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling createCustomImage'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling ImagesApi.createCustomImage, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'createCustomImageRequest' is set
        if ($createCustomImageRequest === null || (is_array($createCustomImageRequest) && count($createCustomImageRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $createCustomImageRequest when calling createCustomImage'
            );
        }
        ...
        // for model (json/xml)
        if (isset($createCustomImageRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($createCustomImageRequest));
            } else {
                $httpBody = $createCustomImageRequest;
            }
     ...
     * @return void
     */
    public function deleteImage($xRequestId, $imageId, $xTraceId = null, string $contentType = self::contentTypes['deleteImage'][0])
    {
        $this->deleteImageWithHttpInfo($xRequestId, $imageId, $xTraceId, $contentType);
    }
     ...
     */
    public function deleteImageWithHttpInfo($xRequestId, $imageId, $xTraceId = null, string $contentType = self::contentTypes['deleteImage'][0])
    {
        $request = $this->deleteImageRequest($xRequestId, $imageId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteImageAsync($xRequestId, $imageId, $xTraceId = null, string $contentType = self::contentTypes['deleteImage'][0])
    {
        return $this->deleteImageAsyncWithHttpInfo($xRequestId, $imageId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteImageAsyncWithHttpInfo($xRequestId, $imageId, $xTraceId = null, string $contentType = self::contentTypes['deleteImage'][0])
    {
        $returnType = '';
        $request = $this->deleteImageRequest($xRequestId, $imageId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteImageRequest($xRequestId, $imageId, $xTraceId = null, string $contentType = self::contentTypes['deleteImage'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling deleteImage'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling ImagesApi.deleteImage, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'imageId' is set
        if ($imageId === null || (is_array($imageId) && count($imageId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $imageId when calling deleteImage'
            );
        }
    ...
    {
        list($response) = $this->retrieveCustomImagesStatsWithHttpInfo($xRequestId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveCustomImagesStatsAsync($xRequestId, $xTraceId = null, string $contentType = self::contentTypes['retrieveCustomImagesStats'][0])
    {
        return $this->retrieveCustomImagesStatsAsyncWithHttpInfo($xRequestId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveCustomImagesStatsRequest($xRequestId, $xTraceId = null, string $contentType = self::contentTypes['retrieveCustomImagesStats'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveCustomImagesStats'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling ImagesApi.retrieveCustomImagesStats, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->retrieveImageWithHttpInfo($xRequestId, $imageId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveImageAsync($xRequestId, $imageId, $xTraceId = null, string $contentType = self::contentTypes['retrieveImage'][0])
    {
        return $this->retrieveImageAsyncWithHttpInfo($xRequestId, $imageId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveImageRequest($xRequestId, $imageId, $xTraceId = null, string $contentType = self::contentTypes['retrieveImage'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveImage'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling ImagesApi.retrieveImage, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'imageId' is set
        if ($imageId === null || (is_array($imageId) && count($imageId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $imageId when calling retrieveImage'
            );
        }
     ...
     * @param  string|null $name The name of the image (optional)
     * @param  bool|null $standardImage Flag indicating that image is either a standard (true) or a custom image (false) (optional)
    ...
    {
        list($response) = $this->retrieveImageListWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $standardImage, $search, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveImageListAsync($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, $standardImage = null, $search = null, string $contentType = self::contentTypes['retrieveImageList'][0])
    {
        return $this->retrieveImageListAsyncWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $standardImage, $search, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveImageListRequest($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, $standardImage = null, $search = null, string $contentType = self::contentTypes['retrieveImageList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveImageList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling ImagesApi.retrieveImageList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->updateImageWithHttpInfo($xRequestId, $imageId, $updateCustomImageRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateImageAsync($xRequestId, $imageId, $updateCustomImageRequest, $xTraceId = null, string $contentType = self::contentTypes['updateImage'][0])
    {
        return $this->updateImageAsyncWithHttpInfo($xRequestId, $imageId, $updateCustomImageRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateImageRequest($xRequestId, $imageId, $updateCustomImageRequest, $xTraceId = null, string $contentType = self::contentTypes['updateImage'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling updateImage'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling ImagesApi.updateImage, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'imageId' is set
        if ($imageId === null || (is_array($imageId) && count($imageId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $imageId when calling updateImage'
            );
        }

        // verify the required parameter 'updateCustomImageRequest' is set
        if ($updateCustomImageRequest === null || (is_array($updateCustomImageRequest) && count($updateCustomImageRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $updateCustomImageRequest when calling updateImage'
            );
        }
        ...
        // for model (json/xml)
        if (isset($updateCustomImageRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($updateCustomImageRequest));
            } else {
                $httpBody = $updateCustomImageRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
