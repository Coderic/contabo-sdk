...
class UsersObjectStorageCredentialsApi
{
     ...
     * @param  string $objectStorageId The identifier of the S3 object storage (required)
     * @param  int $credentialId The ID of the object storage credential (required)
    ...
    {
        list($response) = $this->getObjectStorageCredentialsWithHttpInfo($xRequestId, $userId, $objectStorageId, $credentialId, $xTraceId, $contentType);
        return $response;
    }
     ...
     */
    public function getObjectStorageCredentialsAsync($xRequestId, $userId, $objectStorageId, $credentialId, $xTraceId = null, string $contentType = self::contentTypes['getObjectStorageCredentials'][0])
    {
        return $this->getObjectStorageCredentialsAsyncWithHttpInfo($xRequestId, $userId, $objectStorageId, $credentialId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function getObjectStorageCredentialsRequest($xRequestId, $userId, $objectStorageId, $credentialId, $xTraceId = null, string $contentType = self::contentTypes['getObjectStorageCredentials'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling getObjectStorageCredentials'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersObjectStorageCredentialsApi.getObjectStorageCredentials, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'userId' is set
        if ($userId === null || (is_array($userId) && count($userId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $userId when calling getObjectStorageCredentials'
            );
        }
        ...
        if ($objectStorageId === null || (is_array($objectStorageId) && count($objectStorageId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $objectStorageId when calling getObjectStorageCredentials'
            );
        }
        ...
        if ($credentialId === null || (is_array($credentialId) && count($credentialId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $credentialId when calling getObjectStorageCredentials'
            );
        }
     ...
     * @param  string|null $objectStorageId The identifier of the S3 object storage (optional)
     * @param  string|null $regionName Filter for Object Storage by regions. Available regions: Asia (Singapore), European Union, United States (Central) (optional)
    ...
    {
        list($response) = $this->listObjectStorageCredentialsWithHttpInfo($xRequestId, $userId, $xTraceId, $page, $size, $orderBy, $objectStorageId, $regionName, $displayName, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listObjectStorageCredentialsAsync($xRequestId, $userId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $objectStorageId = null, $regionName = null, $displayName = null, string $contentType = self::contentTypes['listObjectStorageCredentials'][0])
    {
        return $this->listObjectStorageCredentialsAsyncWithHttpInfo($xRequestId, $userId, $xTraceId, $page, $size, $orderBy, $objectStorageId, $regionName, $displayName, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listObjectStorageCredentialsRequest($xRequestId, $userId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $objectStorageId = null, $regionName = null, $displayName = null, string $contentType = self::contentTypes['listObjectStorageCredentials'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling listObjectStorageCredentials'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersObjectStorageCredentialsApi.listObjectStorageCredentials, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'userId' is set
        if ($userId === null || (is_array($userId) && count($userId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $userId when calling listObjectStorageCredentials'
            );
        }
    ...
    {
        list($response) = $this->regenerateObjectStorageCredentialsWithHttpInfo($xRequestId, $userId, $objectStorageId, $credentialId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function regenerateObjectStorageCredentialsAsync($xRequestId, $userId, $objectStorageId, $credentialId, $xTraceId = null, string $contentType = self::contentTypes['regenerateObjectStorageCredentials'][0])
    {
        return $this->regenerateObjectStorageCredentialsAsyncWithHttpInfo($xRequestId, $userId, $objectStorageId, $credentialId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function regenerateObjectStorageCredentialsRequest($xRequestId, $userId, $objectStorageId, $credentialId, $xTraceId = null, string $contentType = self::contentTypes['regenerateObjectStorageCredentials'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling regenerateObjectStorageCredentials'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersObjectStorageCredentialsApi.regenerateObjectStorageCredentials, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'userId' is set
        if ($userId === null || (is_array($userId) && count($userId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $userId when calling regenerateObjectStorageCredentials'
            );
        }
        ...
        if ($objectStorageId === null || (is_array($objectStorageId) && count($objectStorageId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $objectStorageId when calling regenerateObjectStorageCredentials'
            );
        }
        ...
        if ($credentialId === null || (is_array($credentialId) && count($credentialId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $credentialId when calling regenerateObjectStorageCredentials'
            );
        }
