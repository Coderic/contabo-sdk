...
class InternalChecksApi
{
    ...
    {
        list($response) = $this->cancelCheckWithHttpInfo($xRequestId, $checkId, $orgId, $cancelRequest, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation cancelCheckWithHttpInfo
     *
     * Cancel check
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     */
    public function cancelCheckAsync($xRequestId, $checkId, $orgId, $cancelRequest, $xTraceId = null, string $contentType = self::contentTypes['cancelCheck'][0])
    {
        return $this->cancelCheckAsyncWithHttpInfo($xRequestId, $checkId, $orgId, $cancelRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cancelCheckAsyncWithHttpInfo
     *
     * Cancel check
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'cancelCheck'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  float $checkId Check&#39;s id (required)
     * @param  string $orgId Org ID (required)
     ...
     */
    public function cancelCheckRequest($xRequestId, $checkId, $orgId, $cancelRequest, $xTraceId = null, string $contentType = self::contentTypes['cancelCheck'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling cancelCheck'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalChecksApi.cancelCheck, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'checkId' is set
        if ($checkId === null || (is_array($checkId) && count($checkId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkId when calling cancelCheck'
            );
        }
        ...
        if ($orgId === null || (is_array($orgId) && count($orgId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgId when calling cancelCheck'
            );
        }
        ...
        if ($cancelRequest === null || (is_array($cancelRequest) && count($cancelRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cancelRequest when calling cancelCheck'
            );
        }



        $resourcePath = '/internal/v1/troubleshooting/checks/{orgId}/{checkId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getCheckWithHttpInfo($xRequestId, $checkId, $orgId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCheckAsync($xRequestId, $checkId, $orgId, $xTraceId = null, string $contentType = self::contentTypes['getCheck'][0])
    {
        return $this->getCheckAsyncWithHttpInfo($xRequestId, $checkId, $orgId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCheckRequest($xRequestId, $checkId, $orgId, $xTraceId = null, string $contentType = self::contentTypes['getCheck'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling getCheck'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalChecksApi.getCheck, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'checkId' is set
        if ($checkId === null || (is_array($checkId) && count($checkId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkId when calling getCheck'
            );
        }
        ...
        if ($orgId === null || (is_array($orgId) && count($orgId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgId when calling getCheck'
            );
        }
    ...
    {
        list($response) = $this->listChecksWithHttpInfo($xRequestId, $orgIds, $xTraceId, $objectType, $objectId, $status, $checkCollectionId, $checkTemplateId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $modificationStartTime, $modificationEndTime, $accountId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listChecksAsync($xRequestId, $orgIds, $xTraceId = null, $objectType = null, $objectId = null, $status = null, $checkCollectionId = null, $checkTemplateId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $modificationStartTime = null, $modificationEndTime = null, $accountId = null, string $contentType = self::contentTypes['listChecks'][0])
    {
        return $this->listChecksAsyncWithHttpInfo($xRequestId, $orgIds, $xTraceId, $objectType, $objectId, $status, $checkCollectionId, $checkTemplateId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $modificationStartTime, $modificationEndTime, $accountId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listChecksRequest($xRequestId, $orgIds, $xTraceId = null, $objectType = null, $objectId = null, $status = null, $checkCollectionId = null, $checkTemplateId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $modificationStartTime = null, $modificationEndTime = null, $accountId = null, string $contentType = self::contentTypes['listChecks'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling listChecks'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalChecksApi.listChecks, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'orgIds' is set
        if ($orgIds === null || (is_array($orgIds) && count($orgIds) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgIds when calling listChecks'
            );
        }
        ...
        $resourcePath = '/internal/v1/troubleshooting/checks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->startCheckWithHttpInfo($xRequestId, $checkCreateRequest, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation startCheckWithHttpInfo
     *
     * Start check
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function startCheckAsync($xRequestId, $checkCreateRequest, $xTraceId = null, string $contentType = self::contentTypes['startCheck'][0])
    {
        return $this->startCheckAsyncWithHttpInfo($xRequestId, $checkCreateRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation startCheckAsyncWithHttpInfo
     *
     * Start check
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function startCheckRequest($xRequestId, $checkCreateRequest, $xTraceId = null, string $contentType = self::contentTypes['startCheck'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling startCheck'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalChecksApi.startCheck, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'checkCreateRequest' is set
        if ($checkCreateRequest === null || (is_array($checkCreateRequest) && count($checkCreateRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkCreateRequest when calling startCheck'
            );
        }
        ...
        // for model (json/xml)
        if (isset($checkCreateRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($checkCreateRequest));
            } else {
                $httpBody = $checkCreateRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
