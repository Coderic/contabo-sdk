...
class SecretsApi
{
    ...
    {
        list($response) = $this->createSecretWithHttpInfo($xRequestId, $createSecretRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     */
    public function createSecretAsync($xRequestId, $createSecretRequest, $xTraceId = null, string $contentType = self::contentTypes['createSecret'][0])
    {
        return $this->createSecretAsyncWithHttpInfo($xRequestId, $createSecretRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function createSecretRequest($xRequestId, $createSecretRequest, $xTraceId = null, string $contentType = self::contentTypes['createSecret'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling createSecret'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling SecretsApi.createSecret, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'createSecretRequest' is set
        if ($createSecretRequest === null || (is_array($createSecretRequest) && count($createSecretRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $createSecretRequest when calling createSecret'
            );
        }
        ...
        // for model (json/xml)
        if (isset($createSecretRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($createSecretRequest));
            } else {
                $httpBody = $createSecretRequest;
            }
     ...
     * @return void
     */
    public function deleteSecret($xRequestId, $secretId, $xTraceId = null, string $contentType = self::contentTypes['deleteSecret'][0])
    {
        $this->deleteSecretWithHttpInfo($xRequestId, $secretId, $xTraceId, $contentType);
    }
     ...
     */
    public function deleteSecretWithHttpInfo($xRequestId, $secretId, $xTraceId = null, string $contentType = self::contentTypes['deleteSecret'][0])
    {
        $request = $this->deleteSecretRequest($xRequestId, $secretId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSecretAsync($xRequestId, $secretId, $xTraceId = null, string $contentType = self::contentTypes['deleteSecret'][0])
    {
        return $this->deleteSecretAsyncWithHttpInfo($xRequestId, $secretId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSecretAsyncWithHttpInfo($xRequestId, $secretId, $xTraceId = null, string $contentType = self::contentTypes['deleteSecret'][0])
    {
        $returnType = '';
        $request = $this->deleteSecretRequest($xRequestId, $secretId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteSecretRequest($xRequestId, $secretId, $xTraceId = null, string $contentType = self::contentTypes['deleteSecret'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling deleteSecret'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling SecretsApi.deleteSecret, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'secretId' is set
        if ($secretId === null || (is_array($secretId) && count($secretId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $secretId when calling deleteSecret'
            );
        }
        ...
        if ($secretId !== null) {
            $resourcePath = str_replace(
                '{' . 'secretId' . '}',
                ObjectSerializer::toPathValue($secretId),
                $resourcePath
            );
        }
    ...
    {
        list($response) = $this->retrieveSecretWithHttpInfo($xRequestId, $secretId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveSecretAsync($xRequestId, $secretId, $xTraceId = null, string $contentType = self::contentTypes['retrieveSecret'][0])
    {
        return $this->retrieveSecretAsyncWithHttpInfo($xRequestId, $secretId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveSecretRequest($xRequestId, $secretId, $xTraceId = null, string $contentType = self::contentTypes['retrieveSecret'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveSecret'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling SecretsApi.retrieveSecret, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'secretId' is set
        if ($secretId === null || (is_array($secretId) && count($secretId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $secretId when calling retrieveSecret'
            );
        }
     ...
     * @param  string|null $name Filter secrets by name (optional)
    ...
    {
        list($response) = $this->retrieveSecretListWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $type, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveSecretListAsync($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, $type = null, string $contentType = self::contentTypes['retrieveSecretList'][0])
    {
        return $this->retrieveSecretListAsyncWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveSecretListRequest($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, $type = null, string $contentType = self::contentTypes['retrieveSecretList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveSecretList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling SecretsApi.retrieveSecretList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->updateSecretWithHttpInfo($xRequestId, $secretId, $updateSecretRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSecretAsync($xRequestId, $secretId, $updateSecretRequest, $xTraceId = null, string $contentType = self::contentTypes['updateSecret'][0])
    {
        return $this->updateSecretAsyncWithHttpInfo($xRequestId, $secretId, $updateSecretRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateSecretRequest($xRequestId, $secretId, $updateSecretRequest, $xTraceId = null, string $contentType = self::contentTypes['updateSecret'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling updateSecret'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling SecretsApi.updateSecret, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'secretId' is set
        if ($secretId === null || (is_array($secretId) && count($secretId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $secretId when calling updateSecret'
            );
        }

        // verify the required parameter 'updateSecretRequest' is set
        if ($updateSecretRequest === null || (is_array($updateSecretRequest) && count($updateSecretRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $updateSecretRequest when calling updateSecret'
            );
        }
        ...
        // for model (json/xml)
        if (isset($updateSecretRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($updateSecretRequest));
            } else {
                $httpBody = $updateSecretRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
