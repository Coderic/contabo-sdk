 ...
 * @link     https://openapi-generator.tech
 */
class InternalRemedyTemplatesApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  float $remedyTemplateId Remedy template&#39;s id (required)
    ...
    {
        list($response) = $this->getRemedyTemplateWithHttpInfo($xRequestId, $orgId, $remedyTemplateId, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation getRemedyTemplateWithHttpInfo
     *
     * Get remedy
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation getRemedyTemplateAsync
     *
     * Get remedy
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     */
    public function getRemedyTemplateAsync($xRequestId, $orgId, $remedyTemplateId, $xTraceId = null, string $contentType = self::contentTypes['getRemedyTemplate'][0])
    {
        return $this->getRemedyTemplateAsyncWithHttpInfo($xRequestId, $orgId, $remedyTemplateId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRemedyTemplateAsyncWithHttpInfo
     *
     * Get remedy
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'getRemedyTemplate'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  string $orgId Org ID (required)
     * @param  float $remedyTemplateId Remedy template&#39;s id (required)
     ...
     */
    public function getRemedyTemplateRequest($xRequestId, $orgId, $remedyTemplateId, $xTraceId = null, string $contentType = self::contentTypes['getRemedyTemplate'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling getRemedyTemplate'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalRemedyTemplatesApi.getRemedyTemplate, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'orgId' is set
        if ($orgId === null || (is_array($orgId) && count($orgId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgId when calling getRemedyTemplate'
            );
        }

        // verify the required parameter 'remedyTemplateId' is set
        if ($remedyTemplateId === null || (is_array($remedyTemplateId) && count($remedyTemplateId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $remedyTemplateId when calling getRemedyTemplate'
            );
        }



        $resourcePath = '/internal/v1/troubleshooting/remedy-templates/{orgId}/{remedyTemplateId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($remedyTemplateId !== null) {
            $resourcePath = str_replace(
                '{' . 'remedyTemplateId' . '}',
                ObjectSerializer::toPathValue($remedyTemplateId),
                $resourcePath
            );
        }
     ...
     * @param  bool|null $internal Is remedy only internal (not shown to the customer) (optional)
     * @param  string|null $objectType Object type for which the remedy template can be used (optional)
     * @param  string|null $collectorClass Class used to collect the required information for the remedy (optional)
    ...
    {
        list($response) = $this->listRemedyTemplatesWithHttpInfo($xRequestId, $orgIds, $xTraceId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $modificationStartTime, $modificationEndTime, $accountId, $internal, $objectType, $collectorClass, $remedyClass, $contentType);
        return $response;
    }

    /**
     * Operation listRemedyTemplatesWithHttpInfo
     *
     * List remedy templates
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation listRemedyTemplatesAsync
     *
     * List remedy templates
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listRemedyTemplatesAsync($xRequestId, $orgIds, $xTraceId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $modificationStartTime = null, $modificationEndTime = null, $accountId = null, $internal = null, $objectType = null, $collectorClass = null, $remedyClass = null, string $contentType = self::contentTypes['listRemedyTemplates'][0])
    {
        return $this->listRemedyTemplatesAsyncWithHttpInfo($xRequestId, $orgIds, $xTraceId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $modificationStartTime, $modificationEndTime, $accountId, $internal, $objectType, $collectorClass, $remedyClass, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listRemedyTemplatesAsyncWithHttpInfo
     *
     * List remedy templates
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'listRemedyTemplates'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  string[] $orgIds Org IDs (required)
     * @param  string|null $xTraceId Identifier to trace group of requests. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listRemedyTemplatesRequest($xRequestId, $orgIds, $xTraceId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $modificationStartTime = null, $modificationEndTime = null, $accountId = null, $internal = null, $objectType = null, $collectorClass = null, $remedyClass = null, string $contentType = self::contentTypes['listRemedyTemplates'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling listRemedyTemplates'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalRemedyTemplatesApi.listRemedyTemplates, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'orgIds' is set
        if ($orgIds === null || (is_array($orgIds) && count($orgIds) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgIds when calling listRemedyTemplates'
            );
        }
        ...
        $resourcePath = '/internal/v1/troubleshooting/remedy-templates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $collectorClass,
            'collectorClass', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
