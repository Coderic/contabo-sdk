...
class SnapshotsApi
{
    ...
    {
        list($response) = $this->createSnapshotWithHttpInfo($xRequestId, $instanceId, $createSnapshotRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     */
    public function createSnapshotAsync($xRequestId, $instanceId, $createSnapshotRequest, $xTraceId = null, string $contentType = self::contentTypes['createSnapshot'][0])
    {
        return $this->createSnapshotAsyncWithHttpInfo($xRequestId, $instanceId, $createSnapshotRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function createSnapshotRequest($xRequestId, $instanceId, $createSnapshotRequest, $xTraceId = null, string $contentType = self::contentTypes['createSnapshot'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling createSnapshot'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling SnapshotsApi.createSnapshot, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'instanceId' is set
        if ($instanceId === null || (is_array($instanceId) && count($instanceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instanceId when calling createSnapshot'
            );
        }

        // verify the required parameter 'createSnapshotRequest' is set
        if ($createSnapshotRequest === null || (is_array($createSnapshotRequest) && count($createSnapshotRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $createSnapshotRequest when calling createSnapshot'
            );
        }
        ...
        // for model (json/xml)
        if (isset($createSnapshotRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($createSnapshotRequest));
            } else {
                $httpBody = $createSnapshotRequest;
            }
     ...
     * @return void
     */
    public function deleteSnapshot($xRequestId, $instanceId, $snapshotId, $xTraceId = null, string $contentType = self::contentTypes['deleteSnapshot'][0])
    {
        $this->deleteSnapshotWithHttpInfo($xRequestId, $instanceId, $snapshotId, $xTraceId, $contentType);
    }
     ...
     */
    public function deleteSnapshotWithHttpInfo($xRequestId, $instanceId, $snapshotId, $xTraceId = null, string $contentType = self::contentTypes['deleteSnapshot'][0])
    {
        $request = $this->deleteSnapshotRequest($xRequestId, $instanceId, $snapshotId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSnapshotAsync($xRequestId, $instanceId, $snapshotId, $xTraceId = null, string $contentType = self::contentTypes['deleteSnapshot'][0])
    {
        return $this->deleteSnapshotAsyncWithHttpInfo($xRequestId, $instanceId, $snapshotId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSnapshotAsyncWithHttpInfo($xRequestId, $instanceId, $snapshotId, $xTraceId = null, string $contentType = self::contentTypes['deleteSnapshot'][0])
    {
        $returnType = '';
        $request = $this->deleteSnapshotRequest($xRequestId, $instanceId, $snapshotId, $xTraceId, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteSnapshotRequest($xRequestId, $instanceId, $snapshotId, $xTraceId = null, string $contentType = self::contentTypes['deleteSnapshot'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling deleteSnapshot'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling SnapshotsApi.deleteSnapshot, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'instanceId' is set
        if ($instanceId === null || (is_array($instanceId) && count($instanceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instanceId when calling deleteSnapshot'
            );
        }

        // verify the required parameter 'snapshotId' is set
        if ($snapshotId === null || (is_array($snapshotId) && count($snapshotId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $snapshotId when calling deleteSnapshot'
            );
        }
        ...
        if ($snapshotId !== null) {
            $resourcePath = str_replace(
                '{' . 'snapshotId' . '}',
                ObjectSerializer::toPathValue($snapshotId),
                $resourcePath
            );
        }
    ...
    {
        list($response) = $this->retrieveSnapshotWithHttpInfo($xRequestId, $instanceId, $snapshotId, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveSnapshotAsync($xRequestId, $instanceId, $snapshotId, $xTraceId = null, string $contentType = self::contentTypes['retrieveSnapshot'][0])
    {
        return $this->retrieveSnapshotAsyncWithHttpInfo($xRequestId, $instanceId, $snapshotId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveSnapshotRequest($xRequestId, $instanceId, $snapshotId, $xTraceId = null, string $contentType = self::contentTypes['retrieveSnapshot'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveSnapshot'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling SnapshotsApi.retrieveSnapshot, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'instanceId' is set
        if ($instanceId === null || (is_array($instanceId) && count($instanceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instanceId when calling retrieveSnapshot'
            );
        }
        ...
        if ($snapshotId === null || (is_array($snapshotId) && count($snapshotId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $snapshotId when calling retrieveSnapshot'
            );
        }
    ...
    {
        list($response) = $this->retrieveSnapshotListWithHttpInfo($xRequestId, $instanceId, $xTraceId, $page, $size, $orderBy, $name, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveSnapshotListAsync($xRequestId, $instanceId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, string $contentType = self::contentTypes['retrieveSnapshotList'][0])
    {
        return $this->retrieveSnapshotListAsyncWithHttpInfo($xRequestId, $instanceId, $xTraceId, $page, $size, $orderBy, $name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveSnapshotListRequest($xRequestId, $instanceId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, string $contentType = self::contentTypes['retrieveSnapshotList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveSnapshotList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling SnapshotsApi.retrieveSnapshotList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'instanceId' is set
        if ($instanceId === null || (is_array($instanceId) && count($instanceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instanceId when calling retrieveSnapshotList'
            );
        }
    ...
    {
        list($response) = $this->rollbackSnapshotWithHttpInfo($xRequestId, $instanceId, $snapshotId, $body, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rollbackSnapshotAsync($xRequestId, $instanceId, $snapshotId, $body, $xTraceId = null, string $contentType = self::contentTypes['rollbackSnapshot'][0])
    {
        return $this->rollbackSnapshotAsyncWithHttpInfo($xRequestId, $instanceId, $snapshotId, $body, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function rollbackSnapshotRequest($xRequestId, $instanceId, $snapshotId, $body, $xTraceId = null, string $contentType = self::contentTypes['rollbackSnapshot'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling rollbackSnapshot'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling SnapshotsApi.rollbackSnapshot, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'instanceId' is set
        if ($instanceId === null || (is_array($instanceId) && count($instanceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instanceId when calling rollbackSnapshot'
            );
        }
        ...
        if ($snapshotId === null || (is_array($snapshotId) && count($snapshotId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $snapshotId when calling rollbackSnapshot'
            );
        }
    ...
    {
        list($response) = $this->updateSnapshotWithHttpInfo($xRequestId, $instanceId, $snapshotId, $updateSnapshotRequest, $xTraceId, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSnapshotAsync($xRequestId, $instanceId, $snapshotId, $updateSnapshotRequest, $xTraceId = null, string $contentType = self::contentTypes['updateSnapshot'][0])
    {
        return $this->updateSnapshotAsyncWithHttpInfo($xRequestId, $instanceId, $snapshotId, $updateSnapshotRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateSnapshotRequest($xRequestId, $instanceId, $snapshotId, $updateSnapshotRequest, $xTraceId = null, string $contentType = self::contentTypes['updateSnapshot'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling updateSnapshot'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling SnapshotsApi.updateSnapshot, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'instanceId' is set
        if ($instanceId === null || (is_array($instanceId) && count($instanceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $instanceId when calling updateSnapshot'
            );
        }
        ...
        if ($snapshotId === null || (is_array($snapshotId) && count($snapshotId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $snapshotId when calling updateSnapshot'
            );
        }

        // verify the required parameter 'updateSnapshotRequest' is set
        if ($updateSnapshotRequest === null || (is_array($updateSnapshotRequest) && count($updateSnapshotRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $updateSnapshotRequest when calling updateSnapshot'
            );
        }
        ...
        // for model (json/xml)
        if (isset($updateSnapshotRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($updateSnapshotRequest));
            } else {
                $httpBody = $updateSnapshotRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
