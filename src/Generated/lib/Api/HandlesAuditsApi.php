...
class HandlesAuditsApi
{
    ...
    /**
     * Operation retrieveHandlesAuditsList
     *
     ...
     * @param  string|null $handleId The identifier of the handle. (optional)
    ...
    {
        list($response) = $this->retrieveHandlesAuditsListWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $handleId, $requestId, $changedBy, $startDate, $endDate, $contentType);
        return $response;
    }

    /**
     * Operation retrieveHandlesAuditsListWithHttpInfo
     *
     * List history about your handles (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation retrieveHandlesAuditsListAsync
     *
     * List history about your handles (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     */
    public function retrieveHandlesAuditsListAsync($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $handleId = null, $requestId = null, $changedBy = null, $startDate = null, $endDate = null, string $contentType = self::contentTypes['retrieveHandlesAuditsList'][0])
    {
        return $this->retrieveHandlesAuditsListAsyncWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $handleId, $requestId, $changedBy, $startDate, $endDate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveHandlesAuditsListAsyncWithHttpInfo
     *
     * List history about your handles (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'retrieveHandlesAuditsList'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  string|null $xTraceId Identifier to trace group of requests. (optional)
     * @param  int|null $page Number of page to be fetched. (optional)
     ...
     */
    public function retrieveHandlesAuditsListRequest($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $handleId = null, $requestId = null, $changedBy = null, $startDate = null, $endDate = null, string $contentType = self::contentTypes['retrieveHandlesAuditsList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveHandlesAuditsList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling HandlesAuditsApi.retrieveHandlesAuditsList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        ...
        $resourcePath = '/v1/domains/handles/audits';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
