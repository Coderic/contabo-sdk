...
class CheckCollectionsApi
{
    ...
    /**
     * Operation cancelExtCheckCollection
     *
    ...
    {
        list($response) = $this->cancelExtCheckCollectionWithHttpInfo($xRequestId, $checkCollectionId, $cancelRequest, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation cancelExtCheckCollectionWithHttpInfo
     *
     * Cancel check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation cancelExtCheckCollectionAsync
     *
     * Cancel check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     */
    public function cancelExtCheckCollectionAsync($xRequestId, $checkCollectionId, $cancelRequest, $xTraceId = null, string $contentType = self::contentTypes['cancelExtCheckCollection'][0])
    {
        return $this->cancelExtCheckCollectionAsyncWithHttpInfo($xRequestId, $checkCollectionId, $cancelRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cancelExtCheckCollectionAsyncWithHttpInfo
     *
     * Cancel check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'cancelExtCheckCollection'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  float $checkCollectionId Check collection&#39;s id (required)
     * @param  \Contabo\Generated\Model\CancelRequest $cancelRequest (required)
     ...
     */
    public function cancelExtCheckCollectionRequest($xRequestId, $checkCollectionId, $cancelRequest, $xTraceId = null, string $contentType = self::contentTypes['cancelExtCheckCollection'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling cancelExtCheckCollection'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling CheckCollectionsApi.cancelExtCheckCollection, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        ...
        if ($checkCollectionId === null || (is_array($checkCollectionId) && count($checkCollectionId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkCollectionId when calling cancelExtCheckCollection'
            );
        }
        ...
        if ($cancelRequest === null || (is_array($cancelRequest) && count($cancelRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cancelRequest when calling cancelExtCheckCollection'
            );
        }



        $resourcePath = '/v1/troubleshooting/check-collections/{checkCollectionId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getExtCheckCollection
     *
    ...
    {
        list($response) = $this->getExtCheckCollectionWithHttpInfo($xRequestId, $checkCollectionId, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation getExtCheckCollectionWithHttpInfo
     *
     * Get check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation getExtCheckCollectionAsync
     *
     * Get check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExtCheckCollectionAsync($xRequestId, $checkCollectionId, $xTraceId = null, string $contentType = self::contentTypes['getExtCheckCollection'][0])
    {
        return $this->getExtCheckCollectionAsyncWithHttpInfo($xRequestId, $checkCollectionId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getExtCheckCollectionAsyncWithHttpInfo
     *
     * Get check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'getExtCheckCollection'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  float $checkCollectionId Check collection&#39;s id (required)
     * @param  string|null $xTraceId Identifier to trace group of requests. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExtCheckCollectionRequest($xRequestId, $checkCollectionId, $xTraceId = null, string $contentType = self::contentTypes['getExtCheckCollection'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling getExtCheckCollection'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling CheckCollectionsApi.getExtCheckCollection, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'checkCollectionId' is set
        if ($checkCollectionId === null || (is_array($checkCollectionId) && count($checkCollectionId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkCollectionId when calling getExtCheckCollection'
            );
        }
    ...
    /**
     * Operation listExtCheckCollections
     *
    ...
    {
        list($response) = $this->listExtCheckCollectionsWithHttpInfo($xRequestId, $xTraceId, $objectType, $objectId, $checkCollectionTemplateId, $contentType);
        return $response;
    }

    /**
     * Operation listExtCheckCollectionsWithHttpInfo
     *
     * List check collections
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation listExtCheckCollectionsAsync
     *
     * List check collections
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listExtCheckCollectionsAsync($xRequestId, $xTraceId = null, $objectType = null, $objectId = null, $checkCollectionTemplateId = null, string $contentType = self::contentTypes['listExtCheckCollections'][0])
    {
        return $this->listExtCheckCollectionsAsyncWithHttpInfo($xRequestId, $xTraceId, $objectType, $objectId, $checkCollectionTemplateId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listExtCheckCollectionsAsyncWithHttpInfo
     *
     * List check collections
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'listExtCheckCollections'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  string|null $xTraceId Identifier to trace group of requests. (optional)
     * @param  string|null $objectType Object type to be handled (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listExtCheckCollectionsRequest($xRequestId, $xTraceId = null, $objectType = null, $objectId = null, $checkCollectionTemplateId = null, string $contentType = self::contentTypes['listExtCheckCollections'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling listExtCheckCollections'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling CheckCollectionsApi.listExtCheckCollections, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        ...
        $resourcePath = '/v1/troubleshooting/check-collections';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation startExtCheckCollection
     *
    ...
    {
        list($response) = $this->startExtCheckCollectionWithHttpInfo($xRequestId, $baseCheckCollectionCreateRequest, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation startExtCheckCollectionWithHttpInfo
     *
     * Start check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation startExtCheckCollectionAsync
     *
     * Start check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function startExtCheckCollectionAsync($xRequestId, $baseCheckCollectionCreateRequest, $xTraceId = null, string $contentType = self::contentTypes['startExtCheckCollection'][0])
    {
        return $this->startExtCheckCollectionAsyncWithHttpInfo($xRequestId, $baseCheckCollectionCreateRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation startExtCheckCollectionAsyncWithHttpInfo
     *
     * Start check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function startExtCheckCollectionRequest($xRequestId, $baseCheckCollectionCreateRequest, $xTraceId = null, string $contentType = self::contentTypes['startExtCheckCollection'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling startExtCheckCollection'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling CheckCollectionsApi.startExtCheckCollection, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'baseCheckCollectionCreateRequest' is set
        if ($baseCheckCollectionCreateRequest === null || (is_array($baseCheckCollectionCreateRequest) && count($baseCheckCollectionCreateRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $baseCheckCollectionCreateRequest when calling startExtCheckCollection'
            );
        }
        ...
        // for model (json/xml)
        if (isset($baseCheckCollectionCreateRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($baseCheckCollectionCreateRequest));
            } else {
                $httpBody = $baseCheckCollectionCreateRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
