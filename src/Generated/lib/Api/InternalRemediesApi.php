...
class InternalRemediesApi
{
    ...
    {
        list($response) = $this->cancelRemedyWithHttpInfo($xRequestId, $remedyId, $orgId, $cancelRequest, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation cancelRemedyWithHttpInfo
     *
     * Cancel remedy
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     */
    public function cancelRemedyAsync($xRequestId, $remedyId, $orgId, $cancelRequest, $xTraceId = null, string $contentType = self::contentTypes['cancelRemedy'][0])
    {
        return $this->cancelRemedyAsyncWithHttpInfo($xRequestId, $remedyId, $orgId, $cancelRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cancelRemedyAsyncWithHttpInfo
     *
     * Cancel remedy
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'cancelRemedy'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  float $remedyId Remedy&#39;s id (required)
     * @param  string $orgId Org ID (required)
     ...
     */
    public function cancelRemedyRequest($xRequestId, $remedyId, $orgId, $cancelRequest, $xTraceId = null, string $contentType = self::contentTypes['cancelRemedy'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling cancelRemedy'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalRemediesApi.cancelRemedy, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'remedyId' is set
        if ($remedyId === null || (is_array($remedyId) && count($remedyId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $remedyId when calling cancelRemedy'
            );
        }
        ...
        if ($orgId === null || (is_array($orgId) && count($orgId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgId when calling cancelRemedy'
            );
        }
        ...
        if ($cancelRequest === null || (is_array($cancelRequest) && count($cancelRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cancelRequest when calling cancelRemedy'
            );
        }



        $resourcePath = '/internal/v1/troubleshooting/remedies/{orgId}/{remedyId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getRemedyWithHttpInfo($xRequestId, $remedyId, $orgId, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation getRemedyWithHttpInfo
     *
     * Get remedy
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRemedyAsync($xRequestId, $remedyId, $orgId, $xTraceId = null, string $contentType = self::contentTypes['getRemedy'][0])
    {
        return $this->getRemedyAsyncWithHttpInfo($xRequestId, $remedyId, $orgId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRemedyAsyncWithHttpInfo
     *
     * Get remedy
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'getRemedy'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  float $remedyId Remedy&#39;s id (required)
     * @param  string $orgId Org ID (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRemedyRequest($xRequestId, $remedyId, $orgId, $xTraceId = null, string $contentType = self::contentTypes['getRemedy'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling getRemedy'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalRemediesApi.getRemedy, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'remedyId' is set
        if ($remedyId === null || (is_array($remedyId) && count($remedyId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $remedyId when calling getRemedy'
            );
        }
        ...
        if ($orgId === null || (is_array($orgId) && count($orgId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgId when calling getRemedy'
            );
        }
    ...
    {
        list($response) = $this->listRemediesWithHttpInfo($xRequestId, $orgIds, $xTraceId, $objectType, $objectId, $status, $remedyCollectionId, $remedyTemplateId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $modificationStartTime, $modificationEndTime, $accountId, $contentType);
        return $response;
    }

    /**
     * Operation listRemediesWithHttpInfo
     *
     * List remedy
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listRemediesAsync($xRequestId, $orgIds, $xTraceId = null, $objectType = null, $objectId = null, $status = null, $remedyCollectionId = null, $remedyTemplateId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $modificationStartTime = null, $modificationEndTime = null, $accountId = null, string $contentType = self::contentTypes['listRemedies'][0])
    {
        return $this->listRemediesAsyncWithHttpInfo($xRequestId, $orgIds, $xTraceId, $objectType, $objectId, $status, $remedyCollectionId, $remedyTemplateId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $modificationStartTime, $modificationEndTime, $accountId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listRemediesAsyncWithHttpInfo
     *
     * List remedy
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'listRemedies'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  string[] $orgIds Org IDs (required)
     * @param  string|null $xTraceId Identifier to trace group of requests. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listRemediesRequest($xRequestId, $orgIds, $xTraceId = null, $objectType = null, $objectId = null, $status = null, $remedyCollectionId = null, $remedyTemplateId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $modificationStartTime = null, $modificationEndTime = null, $accountId = null, string $contentType = self::contentTypes['listRemedies'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling listRemedies'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalRemediesApi.listRemedies, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'orgIds' is set
        if ($orgIds === null || (is_array($orgIds) && count($orgIds) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgIds when calling listRemedies'
            );
        }
        ...
        $resourcePath = '/internal/v1/troubleshooting/remedies';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->startRemedyWithHttpInfo($xRequestId, $remediesCreateRequest, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation startRemedyWithHttpInfo
     *
     * Start remedy
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function startRemedyAsync($xRequestId, $remediesCreateRequest, $xTraceId = null, string $contentType = self::contentTypes['startRemedy'][0])
    {
        return $this->startRemedyAsyncWithHttpInfo($xRequestId, $remediesCreateRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation startRemedyAsyncWithHttpInfo
     *
     * Start remedy
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function startRemedyRequest($xRequestId, $remediesCreateRequest, $xTraceId = null, string $contentType = self::contentTypes['startRemedy'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling startRemedy'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalRemediesApi.startRemedy, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'remediesCreateRequest' is set
        if ($remediesCreateRequest === null || (is_array($remediesCreateRequest) && count($remediesCreateRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $remediesCreateRequest when calling startRemedy'
            );
        }
        ...
        // for model (json/xml)
        if (isset($remediesCreateRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($remediesCreateRequest));
            } else {
                $httpBody = $remediesCreateRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
