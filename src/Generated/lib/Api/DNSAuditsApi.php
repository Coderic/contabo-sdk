...
class DNSAuditsApi
{
    ...
    /**
     * Operation retrieveDnsAuditsList
     *
     ...
     * @param  string|null $name Dns Zone name. (optional)
    ...
    {
        list($response) = $this->retrieveDnsAuditsListWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $requestId, $changedBy, $startDate, $endDate, $contentType);
        return $response;
    }

    /**
     * Operation retrieveDnsAuditsListWithHttpInfo
     *
     * List history about your DNS Zones (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation retrieveDnsAuditsListAsync
     *
     * List history about your DNS Zones (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     */
    public function retrieveDnsAuditsListAsync($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, $requestId = null, $changedBy = null, $startDate = null, $endDate = null, string $contentType = self::contentTypes['retrieveDnsAuditsList'][0])
    {
        return $this->retrieveDnsAuditsListAsyncWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $name, $requestId, $changedBy, $startDate, $endDate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveDnsAuditsListAsyncWithHttpInfo
     *
     * List history about your DNS Zones (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'retrieveDnsAuditsList'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  string|null $xTraceId Identifier to trace group of requests. (optional)
     * @param  int|null $page Number of page to be fetched. (optional)
     ...
     */
    public function retrieveDnsAuditsListRequest($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $name = null, $requestId = null, $changedBy = null, $startDate = null, $endDate = null, string $contentType = self::contentTypes['retrieveDnsAuditsList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveDnsAuditsList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling DNSAuditsApi.retrieveDnsAuditsList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        ...
        $resourcePath = '/v1/dns/zones/audits';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation retrieveRecordAuditsList
     *
     ...
     * @param  int|null $size Number of elements per page. (optional)
     * @param  string[]|null $orderBy Specify fields and ordering (ASC for ascending, DESC for descending) in following format &#x60;field:ASC|DESC&#x60;. (optional)
     * @param  int|null $recordId The identifier of the Zone record (optional)
     * @param  string|null $requestId The requestId of the API call which led to the change. (optional)
     * @param  string|null $changedBy UserId of the user which led to the change. (optional)
     * @param  \DateTime|null $startDate Start of search time range. (optional)
     * @param  \DateTime|null $endDate End of search time range. (optional)
    ...
    {
        list($response) = $this->retrieveRecordAuditsListWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $recordId, $requestId, $changedBy, $startDate, $endDate, $contentType);
        return $response;
    }

    /**
     * Operation retrieveRecordAuditsListWithHttpInfo
     *
     * List history about your DNS Records (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation retrieveRecordAuditsListAsync
     *
     * List history about your DNS Records (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveRecordAuditsListAsync($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $recordId = null, $requestId = null, $changedBy = null, $startDate = null, $endDate = null, string $contentType = self::contentTypes['retrieveRecordAuditsList'][0])
    {
        return $this->retrieveRecordAuditsListAsyncWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $recordId, $requestId, $changedBy, $startDate, $endDate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveRecordAuditsListAsyncWithHttpInfo
     *
     * List history about your DNS Records (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'retrieveRecordAuditsList'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  string|null $xTraceId Identifier to trace group of requests. (optional)
     * @param  int|null $page Number of page to be fetched. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrieveRecordAuditsListRequest($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $recordId = null, $requestId = null, $changedBy = null, $startDate = null, $endDate = null, string $contentType = self::contentTypes['retrieveRecordAuditsList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveRecordAuditsList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling DNSAuditsApi.retrieveRecordAuditsList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        ...
        $resourcePath = '/v1/dns/records/audits';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
