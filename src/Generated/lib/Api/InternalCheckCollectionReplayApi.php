 ...
 * @link     https://openapi-generator.tech
 */
class InternalCheckCollectionReplayApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation replayCheckCollection
     *
    ...
    {
        list($response) = $this->replayCheckCollectionWithHttpInfo($xRequestId, $checkCollectionsReplayRequest, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation replayCheckCollectionWithHttpInfo
     *
     * Replay changes for Check
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation replayCheckCollectionAsync
     *
     * Replay changes for Check
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     */
    public function replayCheckCollectionAsync($xRequestId, $checkCollectionsReplayRequest, $xTraceId = null, string $contentType = self::contentTypes['replayCheckCollection'][0])
    {
        return $this->replayCheckCollectionAsyncWithHttpInfo($xRequestId, $checkCollectionsReplayRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation replayCheckCollectionAsyncWithHttpInfo
     *
     * Replay changes for Check
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     */
    public function replayCheckCollectionRequest($xRequestId, $checkCollectionsReplayRequest, $xTraceId = null, string $contentType = self::contentTypes['replayCheckCollection'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling replayCheckCollection'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalCheckCollectionReplayApi.replayCheckCollection, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'checkCollectionsReplayRequest' is set
        if ($checkCollectionsReplayRequest === null || (is_array($checkCollectionsReplayRequest) && count($checkCollectionsReplayRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkCollectionsReplayRequest when calling replayCheckCollection'
            );
        }



        $resourcePath = '/internal/v1/troubleshooting/check-collections/replays';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($checkCollectionsReplayRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($checkCollectionsReplayRequest));
            } else {
                $httpBody = $checkCollectionsReplayRequest;
            }
