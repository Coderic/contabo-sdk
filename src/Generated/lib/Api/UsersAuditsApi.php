...
class UsersAuditsApi
{
     ...
     * @param  string|null $userId The identifier of the user. (optional)
    ...
    {
        list($response) = $this->retrieveUserAuditsListWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $userId, $requestId, $changedBy, $startDate, $endDate, $contentType);
        return $response;
    }
     ...
     */
    public function retrieveUserAuditsListAsync($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $userId = null, $requestId = null, $changedBy = null, $startDate = null, $endDate = null, string $contentType = self::contentTypes['retrieveUserAuditsList'][0])
    {
        return $this->retrieveUserAuditsListAsyncWithHttpInfo($xRequestId, $xTraceId, $page, $size, $orderBy, $userId, $requestId, $changedBy, $startDate, $endDate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function retrieveUserAuditsListRequest($xRequestId, $xTraceId = null, $page = null, $size = null, $orderBy = null, $userId = null, $requestId = null, $changedBy = null, $startDate = null, $endDate = null, string $contentType = self::contentTypes['retrieveUserAuditsList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveUserAuditsList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling UsersAuditsApi.retrieveUserAuditsList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
