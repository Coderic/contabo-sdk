 ...
 * @link     https://openapi-generator.tech
 */
class InternalCheckCollectionsApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation cancelCheckCollection
     *
    ...
    {
        list($response) = $this->cancelCheckCollectionWithHttpInfo($xRequestId, $checkCollectionId, $orgId, $cancelRequest, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation cancelCheckCollectionWithHttpInfo
     *
     * Cancel check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation cancelCheckCollectionAsync
     *
     * Cancel check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     */
    public function cancelCheckCollectionAsync($xRequestId, $checkCollectionId, $orgId, $cancelRequest, $xTraceId = null, string $contentType = self::contentTypes['cancelCheckCollection'][0])
    {
        return $this->cancelCheckCollectionAsyncWithHttpInfo($xRequestId, $checkCollectionId, $orgId, $cancelRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cancelCheckCollectionAsyncWithHttpInfo
     *
     * Cancel check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'cancelCheckCollection'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  float $checkCollectionId Check collection&#39;s id (required)
     * @param  string $orgId Org ID (required)
     ...
     */
    public function cancelCheckCollectionRequest($xRequestId, $checkCollectionId, $orgId, $cancelRequest, $xTraceId = null, string $contentType = self::contentTypes['cancelCheckCollection'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling cancelCheckCollection'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalCheckCollectionsApi.cancelCheckCollection, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'checkCollectionId' is set
        if ($checkCollectionId === null || (is_array($checkCollectionId) && count($checkCollectionId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkCollectionId when calling cancelCheckCollection'
            );
        }
        ...
        if ($orgId === null || (is_array($orgId) && count($orgId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgId when calling cancelCheckCollection'
            );
        }
        ...
        if ($cancelRequest === null || (is_array($cancelRequest) && count($cancelRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cancelRequest when calling cancelCheckCollection'
            );
        }



        $resourcePath = '/internal/v1/troubleshooting/check-collections/{orgId}/{checkCollectionId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($checkCollectionId !== null) {
            $resourcePath = str_replace(
                '{' . 'checkCollectionId' . '}',
                ObjectSerializer::toPathValue($checkCollectionId),
                $resourcePath
            );
        }
        // path params
    ...
    {
        list($response) = $this->getCheckCollectionWithHttpInfo($xRequestId, $checkCollectionId, $orgId, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation getCheckCollectionWithHttpInfo
     *
     * Get check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation getCheckCollectionAsync
     *
     * Get check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCheckCollectionAsync($xRequestId, $checkCollectionId, $orgId, $xTraceId = null, string $contentType = self::contentTypes['getCheckCollection'][0])
    {
        return $this->getCheckCollectionAsyncWithHttpInfo($xRequestId, $checkCollectionId, $orgId, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCheckCollectionAsyncWithHttpInfo
     *
     * Get check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'getCheckCollection'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  float $checkCollectionId Check collection&#39;s id (required)
     * @param  string $orgId Org ID (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCheckCollectionRequest($xRequestId, $checkCollectionId, $orgId, $xTraceId = null, string $contentType = self::contentTypes['getCheckCollection'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling getCheckCollection'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalCheckCollectionsApi.getCheckCollection, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'checkCollectionId' is set
        if ($checkCollectionId === null || (is_array($checkCollectionId) && count($checkCollectionId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkCollectionId when calling getCheckCollection'
            );
        }
        ...
        if ($orgId === null || (is_array($orgId) && count($orgId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgId when calling getCheckCollection'
            );
        }
    ...
    /**
     * Operation listCheckCollections
     *
    ...
    {
        list($response) = $this->listCheckCollectionsWithHttpInfo($xRequestId, $orgIds, $xTraceId, $objectType, $objectId, $checkCollectionTemplateId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $modificationStartTime, $modificationEndTime, $accountId, $contentType);
        return $response;
    }

    /**
     * Operation listCheckCollectionsWithHttpInfo
     *
     * List check collections
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation listCheckCollectionsAsync
     *
     * List check collections
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCheckCollectionsAsync($xRequestId, $orgIds, $xTraceId = null, $objectType = null, $objectId = null, $checkCollectionTemplateId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $modificationStartTime = null, $modificationEndTime = null, $accountId = null, string $contentType = self::contentTypes['listCheckCollections'][0])
    {
        return $this->listCheckCollectionsAsyncWithHttpInfo($xRequestId, $orgIds, $xTraceId, $objectType, $objectId, $checkCollectionTemplateId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $modificationStartTime, $modificationEndTime, $accountId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listCheckCollectionsAsyncWithHttpInfo
     *
     * List check collections
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'listCheckCollections'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  string[] $orgIds Org IDs (required)
     * @param  string|null $xTraceId Identifier to trace group of requests. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listCheckCollectionsRequest($xRequestId, $orgIds, $xTraceId = null, $objectType = null, $objectId = null, $checkCollectionTemplateId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $modificationStartTime = null, $modificationEndTime = null, $accountId = null, string $contentType = self::contentTypes['listCheckCollections'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling listCheckCollections'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalCheckCollectionsApi.listCheckCollections, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'orgIds' is set
        if ($orgIds === null || (is_array($orgIds) && count($orgIds) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgIds when calling listCheckCollections'
            );
        }
        ...
        $resourcePath = '/internal/v1/troubleshooting/check-collections';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'checkCollectionTemplateId', // param base name
            'number', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    /**
     * Operation startCheckCollection
     *
    ...
    {
        list($response) = $this->startCheckCollectionWithHttpInfo($xRequestId, $checkCollectionCreateRequest, $xTraceId, $contentType);
        return $response;
    }

    /**
     * Operation startCheckCollectionWithHttpInfo
     *
     * Start check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation startCheckCollectionAsync
     *
     * Start check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function startCheckCollectionAsync($xRequestId, $checkCollectionCreateRequest, $xTraceId = null, string $contentType = self::contentTypes['startCheckCollection'][0])
    {
        return $this->startCheckCollectionAsyncWithHttpInfo($xRequestId, $checkCollectionCreateRequest, $xTraceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation startCheckCollectionAsyncWithHttpInfo
     *
     * Start check collection
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function startCheckCollectionRequest($xRequestId, $checkCollectionCreateRequest, $xTraceId = null, string $contentType = self::contentTypes['startCheckCollection'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling startCheckCollection'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalCheckCollectionsApi.startCheckCollection, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'checkCollectionCreateRequest' is set
        if ($checkCollectionCreateRequest === null || (is_array($checkCollectionCreateRequest) && count($checkCollectionCreateRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checkCollectionCreateRequest when calling startCheckCollection'
            );
        }
        ...
        // for model (json/xml)
        if (isset($checkCollectionCreateRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($checkCollectionCreateRequest));
            } else {
                $httpBody = $checkCollectionCreateRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
