...
class InternalRemedyAuditsApi
{
    ...
    /**
     * Operation retrieveRemediesAuditsList
     *
    ...
    {
        list($response) = $this->retrieveRemediesAuditsListWithHttpInfo($xRequestId, $orgIds, $xTraceId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $accountId, $requestId, $foreignChangedBy, $changedBy, $remedyId, $contentType);
        return $response;
    }

    /**
     * Operation retrieveRemediesAuditsListWithHttpInfo
     *
     * List history about your Data (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Operation retrieveRemediesAuditsListAsync
     *
     * List history about your Data (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     ...
     */
    public function retrieveRemediesAuditsListAsync($xRequestId, $orgIds, $xTraceId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $accountId = null, $requestId = null, $foreignChangedBy = null, $changedBy = null, $remedyId = null, string $contentType = self::contentTypes['retrieveRemediesAuditsList'][0])
    {
        return $this->retrieveRemediesAuditsListAsyncWithHttpInfo($xRequestId, $orgIds, $xTraceId, $page, $size, $orderBy, $creationStartTime, $creationEndTime, $accountId, $requestId, $foreignChangedBy, $changedBy, $remedyId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveRemediesAuditsListAsyncWithHttpInfo
     *
     * List history about your Data (audit)
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
    ...
    /**
     * Create request for operation 'retrieveRemediesAuditsList'
     *
     * @param  string $xRequestId [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually. (required)
     * @param  string[] $orgIds Org IDs (required)
     * @param  string|null $xTraceId Identifier to trace group of requests. (optional)
     ...
     */
    public function retrieveRemediesAuditsListRequest($xRequestId, $orgIds, $xTraceId = null, $page = null, $size = null, $orderBy = null, $creationStartTime = null, $creationEndTime = null, $accountId = null, $requestId = null, $foreignChangedBy = null, $changedBy = null, $remedyId = null, string $contentType = self::contentTypes['retrieveRemediesAuditsList'][0])
    {

        // verify the required parameter 'xRequestId' is set
        if ($xRequestId === null || (is_array($xRequestId) && count($xRequestId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xRequestId when calling retrieveRemediesAuditsList'
            );
        }
        if (!preg_match("/^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $xRequestId)) {
            throw new \InvalidArgumentException("invalid value for \"xRequestId\" when calling InternalRemedyAuditsApi.retrieveRemediesAuditsList, must conform to the pattern /^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[0-5][0-9A-Fa-f]{3}-[089abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'orgIds' is set
        if ($orgIds === null || (is_array($orgIds) && count($orgIds) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orgIds when calling retrieveRemediesAuditsList'
            );
        }
        ...
        $resourcePath = '/internal/v1/troubleshooting/remedies/audits';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
